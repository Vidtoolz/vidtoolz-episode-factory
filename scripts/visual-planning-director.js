...
function buildPrompt(task) {
  ...
  // V2 VISUAL_DRAFT grammar lines (doctrine full_frame_composition /
  // background_cadence / script_binding): the model designs unique full-frame
  // backgrounds bound to spoken meaning. Deliberately NO presenter concept is
