...
Run: python3 -B tools/validate_v1_18.py
"""
import ast
import copy
import glob
...
# v1.18 (V116-B1 / Codex section 55.5): every artifact is registered with a STATUS and a published ROLE, so audits
...
rec("precedence", "the v1.5 through v1.16 changelogs and finding matrices are HISTORICAL; the v1.18 ones are active", all(st_.get(d_) == "HISTORICAL" for d_ in ("CHANGELOG-v1.5.md", "FINDING-RESOLUTION-MATRIX-v1.5.md", "CHANGELOG-v1.6.md", "FINDING-RESOLUTION-MATRIX-v1.6.md", "CHANGELOG-v1.7.md", "FINDING-RESOLUTION-MATRIX-v1.7.md", "CHANGELOG-v1.8.md", "FINDING-RESOLUTION-MATRIX-v1.8.md", "CHANGELOG-v1.9.md", "FINDING-RESOLUTION-MATRIX-v1.9.md", "CHANGELOG-v1.10.md", "FINDING-RESOLUTION-MATRIX-v1.10.md", "CHANGELOG-v1.11.md", "FINDING-RESOLUTION-MATRIX-v1.11.md", "CHANGELOG-v1.12.md", "FINDING-RESOLUTION-MATRIX-v1.12.md", "CHANGELOG-v1.13.md", "FINDING-RESOLUTION-MATRIX-v1.13.md", "CHANGELOG-v1.14.md", "FINDING-RESOLUTION-MATRIX-v1.14.md", "CHANGELOG-v1.15.md", "FINDING-RESOLUTION-MATRIX-v1.15.md", "CHANGELOG-v1.16.md", "FINDING-RESOLUTION-MATRIX-v1.16.md")) and st_.get("CHANGELOG-v1.18.md") == "STILL_ACTIVE" and st_.get("FINDING-RESOLUTION-MATRIX-v1.18.md") == "STILL_ACTIVE")
...
# v1.18: every artifact is now registered in precedence with a STATUS and a ROLE, so this audit can say exactly what
...
if os.path.exists(man_path):
    ...
    parent = L.strict_load(os.path.join(os.path.dirname(B), "v1.17", "FREEZE-MANIFEST.json"))
    ...
    rec("manifest", "the parent block records the v1.17 branch HEAD and its semantic commit, which for v1.17 are the same commit because its bundle and registration were committed together (section 29)", man["parent"]["head"] == "24ead748eec4bce46dc2e945d24ad403fc9472b3" and man["parent"]["semantic_head"] == "24ead748eec4bce46dc2e945d24ad403fc9472b3" and man["parent"]["manifest_sha256"] == "5dff9c98f1086ea6a4edfab0073770597554ab338e276ed88125e94796eb91af" and man["parent"]["version"] == "1.17.0" and {a["version"] for a in man["parent"]["ancestors"]} >= {"1.15.0", "1.14.0", "1.13.0"})
...
try:
    ...
    # v1.18 (V116-B1): this regression is now evaluated by tools/authority_slots.py - clause-local, structured,
...
# ---- v1.18 (V116-B1): slots are DISCOVERED, not read from a hand-written dictionary. The v1.16 inventory listed
...
# v1.18 replaces publication-scanner assertions; protected runtime/receipt checks remain below.
...
# ================================================================ 23. v1.18: Codex's sole v1.16 finding
...
# v1.18 scanner and release regressions are in a bounded tooling-only module.
import v118_tests
v118_tests.run(B, rec)
