# GUARD-AUTHORITY.md — pre-write / re-validation guard (v1.3, FROZEN_NOW)
...
payload_sha256 = sha256( utf8("vidtoolz.resolveSnapshotPayload.v1.3") + 0x0A + canonical(normalized payload) )
```
