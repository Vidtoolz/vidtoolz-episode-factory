...
| R7 F15-07 / M-PRECEDENCE transaction lifecycle precedence | precedence, precedence-supersession, precedence-retired-terms | 262 | 262 |
...
| evidence-set-binding-negative | attached-evidence-raised-fake-parse-block | PASS | 0349fc21b47b: capture carries forbidden interpretation field 'parse'; 0349fc21b47b: capture carries forbidden interpretation field 'result' |
| evidence-set-schema | attached-evidence-raw-tampered | PASS |  |
| evidence-set-binding-negative | attached-evidence-raw-tampered | PASS | 037a6caa878f: capture raw_digest does not re-hash; 042c13bfebcd: capture raw_digest does not re-hash |
...
| evidence-set-binding-negative | attached-fatal-probe-failure | PASS | 0d5c0b1d4bcd: capture binding library_root disagrees with envelope/contract/active authority; 0d5c0b1d4bcd: capture binding library_uuid disagrees with envelope/contract/active authority |
...
| evidence-set-binding-negative | invalid-bundle-other-manifest-not-historical | PASS | 64905250750f: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema | invalid-connection-other-authority | PASS |  |
| evidence-set-binding-negative | invalid-connection-other-authority | PASS | 6915d776af35: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.20.0 |
| evidence-set-schema | invalid-connection-wrong-manifest | PASS |  |
| evidence-set-binding-negative | invalid-connection-wrong-manifest | PASS | ec3c19a0bad9: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest |
...
| evidence-set-binding-negative | invalid-provisioning-without-root | PASS | 098f2e38e2e7: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY |
...
| evidence-set-binding-negative | invalid-retired-capability-evidence-type | PASS | 4c0dc18533a5: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review) |
| evidence-set-schema | invalid-tampered-record | PASS |  |
| evidence-set-binding-negative | invalid-tampered-record | PASS | 662d5c4bf2f4: record_id does not match content digest |
...
| evidence-ref-negative | uppercase sha | PASS | M3_AUTHORIZATION: reference is not a sha256 ('4A07C0D3009AFC815D072AA4982F06FB61DFC38E099C4FD2A6C33D4F90DBDE80') |
| evidence-ref-negative | unlinked sha | PASS | M3_AUTHORIZATION: referenced record 999999999999 not in evidence set |
| evidence-ref-negative | wrong type | PASS | M3_AUTHORIZATION: record 4a07c0d3009a has type PROVISIONING_RECORD |
| evidence-ref-negative | short hex | PASS | M3_AUTHORIZATION: reference is not a sha256 ('4a07c0d3009afc815d072aa4982f06fb61dfc38e099c4fd2a6c33d4f90dbde8') |
...
| attachment-derived | attached-evidence-raised-fake-parse-block -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', "0349fc21b47b: capture carries forbidden interpretation field 'parse'"] conflicts=[] |
| attachment-derived | attached-evidence-raw-tampered -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '037a6caa878f: capture raw_digest does not re-hash'] conflicts=[] |
...
| attachment-derived | attached-fatal-probe-failure -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '0d5c0b1d4bcd: capture binding library_root disagrees with envelope/contract/active authority'] conflicts=[] |
...
| attachment-derived | invalid-bundle-other-manifest-not-historical -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '64905250750f: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-connection-other-authority -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '6915d776af35: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.20.0'] conflicts=[] |
| attachment-derived | invalid-connection-wrong-manifest -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'ec3c19a0bad9: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-provisioning-without-root -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '098f2e38e2e7: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY'] conflicts=[] |
| attachment-derived | invalid-retired-capability-evidence-type -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '4c0dc18533a5: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review)'] conflicts=[] |
| attachment-derived | invalid-tampered-record -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '662d5c4bf2f4: record_id does not match content digest'] conflicts=[] |
...
| refreeze-law | a refreeze from another session is refused | PASS | Timeline.GetUniqueId: raw capture from another probe/session |
| refreeze-law | a refreeze from another probe run is refused | PASS | Timeline.GetUniqueId: raw capture from another probe/session |
...
| fixture-schema-negative | plan-authority-version-old | PASS | const:authority_version:'1.20.0' was expected |
| fixture-schema-positive | plan-digest-not-of-body | PASS |  |
| fixture-semantic-negative | plan-digest-not-of-body | PASS | plan_digest does not match plan body digest; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 6cfc8 |
| fixture-schema-positive | plan-duplicate-operation-id | PASS |  |
| fixture-semantic-negative | plan-duplicate-operation-id | PASS | operation ids must be unique and non-empty; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 6cfc84 |
| fixture-schema-positive | plan-eligible-without-prepared-journal | PASS |  |
| fixture-eligibility-negative | plan-eligible-without-prepared-journal | PASS | operation APPEND not eligible: ['JOURNAL_PREPARED (JOURNAL_PREPARED: referenced record 02da440450f1 not in evidence set)', 'PLAN_VALIDATED (PLAN_VALIDATION: referenced record 6cfc84f1c990 not in evidence set)', 'GUARD_CU |
...
| fixture-semantic-negative | plan-operation-set-digest-mismatch | PASS | operation_set_digest does not match operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 6c |
| fixture-schema-positive | plan-plan-validation-record-fail | PASS |  |
| fixture-eligibility-negative | plan-plan-validation-record-fail | PASS | operation APPEND not eligible: ['PLAN_VALIDATED (PLAN_VALIDATION: referenced record 6cfc84f1c990 not in evidence set)'] |
| fixture-schema-positive | plan-read-class-with-append | PASS |  |
| fixture-semantic-negative | plan-read-class-with-append | PASS | RESOLVE_READ permission class cannot carry write operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATI |
| fixture-schema-positive | plan-selector-target-mismatch | PASS |  |
| fixture-semantic-negative | plan-selector-target-mismatch | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 6cfc84f1c990 plan_digest='<SHA256>' != '<SHA256>') |
| fixture-schema-positive | plan-session-not-current | PASS |  |
| fixture-semantic-negative | plan-session-not-current | PASS | plan session_id != evidence set current_session_id (execution session mismatch); operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALI |
| fixture-schema-positive | plan-stale-guard | PASS |  |
| fixture-semantic-negative | plan-stale-guard | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 6cfc84f1c990 plan_digest='<SHA256>' != '<SHA256>') |
...
| linked-set-negative | linked-set-effect-not-specified-claims-verified | PASS | plan: operation SET_PROPERTIES not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 6cfc84f1c990 plan_digest='<SHA256>'  |
...
| eligibility | m0-deny-ref-wrong-record-type | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['READ_ONLY_JOURNAL_OPEN (READ_ONLY_JOURNAL: record 662d5c4bf2f4 has type CONNECTION_OBSERVATION)'] codes=['PREREQUISITES_FAILED'] |
...
| eligibility | m3-append-deny-authorization-old-authority | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record 44fdb4eb1370 not in evidence set)', 'TARGET_STATE_SCRATCH_WRITE_READY (no M3_AUTHORIZATION  |
...
| eligibility | m3-save-deny-ids-unavailable | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT failed=['M2_EXIT_EVIDENCE (MILESTONE_EXIT: referenced record 8ce7f37477b5 not in evidence set)', 'MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record 44fdb4eb137 |
...
| eligibility | m3-append-deny-h0-minimal-m0 | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_PROFILE: snapshot profile 'MINIMAL_ |
| eligibility-request-schema | m3-append-deny-h0-full-timeline-read | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-full-timeline-read | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_PROFILE: snapshot profile 'FULL_TIM |
| eligibility-request-schema | m3-append-deny-h0-incomplete-write-precheck | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-incomplete-write-precheck | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_INCOMPLETE: guarded snapshot is not |
| eligibility-request-schema | m3-append-deny-h0-candidate-provenance | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-candidate-provenance | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_PROVENANCE: Folder.GetUniqueId is C |
| eligibility-request-schema | m3-append-deny-h0-other-matrix | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-matrix | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_MATRIX: guarded snapshot collected  |
| eligibility-request-schema | m3-append-deny-h0-other-target | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-target | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 02da440450f1 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_TARGET: guarded snapshot identity d |
...
| eligibility | m3-append-deny-plan-validation-from-helper | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["PLAN_VALIDATED (PLAN_VALIDATION: record 1d47bc56dc8f validator='tools/authority_lib.py#semantic_mutation_plan' != 'tools/authority_lib.py#validate_tra |
...
| precedence | CHANGELOG-v1.19.md classified | PASS |  |
| precedence | CHANGELOG-v1.2.md classified | PASS |  |
| precedence | CHANGELOG-v1.20.md classified | PASS |  |
...
| precedence | CONTROL-PLANE.md classified | PASS |  |
...
| precedence | FINDING-RESOLUTION-MATRIX-v1.19.json classified | PASS |  |
| precedence | FINDING-RESOLUTION-MATRIX-v1.19.md classified | PASS |  |
| precedence | FINDING-RESOLUTION-MATRIX-v1.2.md classified | PASS |  |
| precedence | FINDING-RESOLUTION-MATRIX-v1.20.json classified | PASS |  |
| precedence | FINDING-RESOLUTION-MATRIX-v1.20.md classified | PASS |  |
...
| precedence | KNOWN-LIMITATIONS-PHASE1.md classified | PASS |  |
| precedence | LINEAGE.md classified | PASS |  |
...
| precedence | PHASE1-QUALIFICATION-RECORD.json classified | PASS |  |
| precedence | PHASE1-SOURCE-PIN.json classified | PASS |  |
...
| precedence-retired-terms | CONTROL-PLANE.md | PASS |  |
...
| precedence-retired-terms | KNOWN-LIMITATIONS-PHASE1.md | PASS |  |
| precedence-retired-terms | LINEAGE.md | PASS |  |
...
| precedence-retired-terms | PHASE1-QUALIFICATION-RECORD.json | PASS |  |
| precedence-retired-terms | PHASE1-SOURCE-PIN.json | PASS |  |
...
| precedence | the v1.5 through v1.16 changelogs and finding matrices are HISTORICAL; the v1.20 ones are active | PASS |  |
...
| precedence | THREAT-MODEL.md records the v1.19 audit-fragility residuals and restates the still-open authorizing-transaction control | PASS |  |
...
| precedence | AUTHORITY-PRECEDENCE.json carries the blanket clause that re-reads every earlier statement's demoted function names as their authorizing counterparts, and v1.19 makes that clause itself clause-local: every demoted name in it carries its class token in the same clause (V114-B3, V116-B1) | PASS |  |
...
| manifest | the parent block records the v1.19 branch HEAD and its semantic commit, which for v1.19 are the same commit because its bundle and registration were committed together (section 29) | PASS |  |
...
| core-positive | the suite owns only the session object it minted and never the shared governed root: an absent root is created with the frozen mode and LEFT IN PLACE, and the run's own session and its aside path are both gone afterwards | PASS | own session removed; shared root retained |
...
| b3-active-naming | the audit actually scanned every CURRENT artifact, machine and prose, not a sample (66 documents) | PASS | 66 scanned |
...
| b1-property | and the exhaustive scan covers every current artifact, machine and prose, with no key-name exemption list (66 artifacts) | PASS | 66 artifacts |
...
| v120-release-scanner | registration-current | PASS | [] |
| v120-release-scanner | external-final-bytes | PASS | [] |
| v120-release-scanner | document-universe | PASS | [] |
| v120-release-scanner | active-finding-map-schema | PASS | [] |
| v120-release-scanner | zero-current | PASS |  |
| v120-release-scanner | duplicate-selector | PASS |  |
| v120-release-scanner | old-current | PASS |  |
| v120-release-scanner | missing-registration | PASS |  |
| v120-release-scanner | stale-prose | PASS |  |
| v120-release-scanner | both-current | PASS |  |
| v120-release-scanner | current-rejected | PASS |  |
| v120-release-scanner | stale-prose-current authority | PASS |  |
| v120-release-scanner | stale-prose-current version | PASS |  |
| v120-release-scanner | stale-prose-active authority | PASS |  |
| v120-release-scanner | stale-prose-active version | PASS |  |
| v120-release-scanner | stale-prose-controlling authority | PASS |  |
...
| v120-release-scanner | inventory-full-equality | PASS |  |
| v120-release-scanner | independent-reference-equality | PASS |  |
| v120-release-scanner | metadata-reference-set-equality | PASS |  |
| v120-release-scanner | independent-source-role-bindings | PASS | [] |
| v120-release-scanner | source-declaration-role-equality | PASS |  |
| v120-release-scanner | source-declaration-slot-equality | PASS |  |
| v120-release-scanner | all-current-reference-roles | PASS | [] |
| v120-release-scanner | former-slot-0 | PASS | PERMISSIONS.json#law |
| v120-release-scanner | former-slot-1 | PASS | M0A-BINDING-VALUES.json#values.verification_result_law |
| v120-release-scanner | former-slot-2 | PASS | M0A-BINDING-VALUES.json#values.toctou_law |
| v120-release-scanner | former-slot-3 | PASS | FREEZE-MANIFEST.json#rules.[4] |
| v120-release-scanner | former-slot-4 | PASS | FREEZE-MANIFEST.json#files.[91].qualification_note |
| v120-release-scanner | slot-omission-00 | PASS |  |
| v120-release-scanner | slot-omission-01 | PASS |  |
| v120-release-scanner | slot-omission-02 | PASS |  |
| v120-release-scanner | slot-omission-03 | PASS |  |
| v120-release-scanner | slot-omission-04 | PASS |  |
| v120-release-scanner | slot-omission-05 | PASS |  |
| v120-release-scanner | slot-omission-06 | PASS |  |
| v120-release-scanner | slot-omission-07 | PASS |  |
| v120-release-scanner | slot-omission-08 | PASS |  |
| v120-release-scanner | slot-omission-09 | PASS |  |
| v120-release-scanner | slot-omission-10 | PASS |  |
| v120-release-scanner | slot-omission-11 | PASS |  |
| v120-release-scanner | slot-omission-12 | PASS |  |
| v120-release-scanner | slot-omission-13 | PASS |  |
| v120-release-scanner | slot-omission-14 | PASS |  |
| v120-release-scanner | slot-omission-15 | PASS |  |
| v120-release-scanner | slot-omission-16 | PASS |  |
| v120-release-scanner | slot-omission-17 | PASS |  |
| v120-release-scanner | slot-omission-18 | PASS |  |
| v120-release-scanner | slot-omission-19 | PASS |  |
| v120-release-scanner | slot-omission-20 | PASS |  |
| v120-release-scanner | slot-omission-21 | PASS |  |
| v120-release-scanner | slot-omission-22 | PASS |  |
| v120-release-scanner | slot-omission-23 | PASS |  |
| v120-release-scanner | edit-after-manifest | PASS |  |
| v120-release-scanner | registration-omission-00 | PASS |  |
| v120-release-scanner | registration-omission-01 | PASS |  |
| v120-release-scanner | registration-omission-02 | PASS |  |
| v120-release-scanner | registration-omission-03 | PASS |  |
| v120-release-scanner | registration-omission-04 | PASS |  |
| v120-release-scanner | registration-omission-05 | PASS |  |
| v120-release-scanner | registration-omission-06 | PASS |  |
| v120-release-scanner | registration-omission-07 | PASS |  |
| v120-release-scanner | registration-omission-08 | PASS |  |
| v120-release-scanner | registration-omission-09 | PASS |  |
| v120-release-scanner | registration-omission-10 | PASS |  |
| v120-release-scanner | registration-omission-11 | PASS |  |
| v120-release-scanner | registration-omission-12 | PASS |  |
| v120-release-scanner | registration-omission-13 | PASS |  |
| v120-release-scanner | registration-omission-14 | PASS |  |
| v120-release-scanner | registration-omission-15 | PASS |  |
| v120-release-scanner | registration-omission-16 | PASS |  |
| v120-release-scanner | registration-omission-17 | PASS |  |
| v120-release-scanner | registration-omission-18 | PASS |  |
| v120-release-scanner | registration-omission-19 | PASS |  |
| v120-release-scanner | registration-omission-20 | PASS |  |
| v120-release-scanner | registration-omission-21 | PASS |  |
| v120-release-scanner | registration-omission-22 | PASS |  |
| v120-release-scanner | registration-omission-23 | PASS |  |
| v120-release-scanner | exact-misregistration-mutant-refused | PASS |  |
| v120-release-scanner | extra-unregistered-normative | PASS |  |
| v120-release-scanner | thirty-case-corpus-size | PASS |  |
| v120-release-scanner | v117-regression-NEG-4 | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-NO-LONGER-DIAGNOSTIC-SINGLE | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-DIAGNOSTIC-REFUSES | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-UNRELATED-NEGATION | PASS | [('derive_attachment_state', 'AMBIGUOUS_CURRENT_REFERENCE')] |
| v120-release-scanner | v117-regression-MIXED-SAME-CLAUSE | PASS | [('derive_attachment_state', 'DIAGNOSTIC_DECLARATION'), ('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION'), ('commit_eligibility', 'DIAGNOSTIC_DECLARATION')] |
| v120-release-scanner | v117-regression-CURRENT-HISTORY-corrected | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-CURRENT-HISTORY-v1.16 | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-CURRENT-HISTORY-historical | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-KEY-DIAGNOSTIC-SUPPRESSION | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-SAFE-KEY-WITHOUT-CLASS | PASS | [('derive_attachment_state', 'AMBIGUOUS_CURRENT_REFERENCE')] |
| v120-release-scanner | v117-regression-VERB-governs-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-governs-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-controls-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-controls-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-determines-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-determines-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-adjudicates-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-adjudicates-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-blocks-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-blocks-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-permits-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-permits-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-certifies-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-certifies-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-rejects-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-rejects-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-establishes-derive_attachment_state | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-VERB-establishes-derive_attachment_state_authorizing | PASS | [('derive_attachment_state_authorizing', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | v117-regression-MODULE-unfamiliar_module | PASS | [('derive_attachment_state', 'MENTION')] |
| v120-release-scanner | v117-regression-WRAP-BULLET | PASS | [('derive_attachment_state', 'AUTHORIZING_DESIGNATION')] |
| v120-release-scanner | unknown-key-00 | PASS |  |
| v120-release-scanner | unknown-key-01 | PASS |  |
| v120-release-scanner | unknown-key-02 | PASS |  |
| v120-release-scanner | unknown-key-03 | PASS |  |
| v120-release-scanner | unknown-key-04 | PASS |  |
| v120-release-scanner | unknown-key-05 | PASS |  |
| v120-release-scanner | unknown-key-06 | PASS |  |
| v120-release-scanner | unknown-key-07 | PASS |  |
| v120-release-scanner | unknown-key-08 | PASS |  |
| v120-release-scanner | unknown-key-09 | PASS |  |
| v120-release-scanner | unknown-key-10 | PASS |  |
| v120-release-scanner | unknown-key-11 | PASS |  |
| v120-release-scanner | unknown-key-12 | PASS |  |
| v120-release-scanner | unknown-key-13 | PASS |  |
| v120-release-scanner | unknown-key-14 | PASS |  |
| v120-release-scanner | unknown-key-15 | PASS |  |
| v120-release-scanner | unknown-key-16 | PASS |  |
| v120-release-scanner | unknown-key-17 | PASS |  |
| v120-release-scanner | unknown-key-18 | PASS |  |
| v120-release-scanner | unknown-key-19 | PASS |  |
| v120-release-scanner | unknown-key-20 | PASS |  |
| v120-release-scanner | unknown-key-21 | PASS |  |
| v120-release-scanner | unknown-key-22 | PASS |  |
| v120-release-scanner | unknown-key-23 | PASS |  |
| v120-release-scanner | unknown-key-24 | PASS |  |
| v120-release-scanner | unknown-key-25 | PASS |  |
| v120-release-scanner | unknown-key-26 | PASS |  |
| v120-release-scanner | unknown-key-27 | PASS |  |
| v120-release-scanner | unknown-key-28 | PASS |  |
| v120-release-scanner | unknown-key-29 | PASS |  |
| v120-release-scanner | unknown-key-30 | PASS |  |
| v120-release-scanner | unknown-key-31 | PASS |  |
| v120-release-scanner | unknown-key-32 | PASS |  |
| v120-release-scanner | unknown-key-33 | PASS |  |
| v120-release-scanner | unknown-key-34 | PASS |  |
| v120-release-scanner | unknown-key-35 | PASS |  |
| v120-release-scanner | unknown-key-36 | PASS |  |
| v120-release-scanner | unknown-key-37 | PASS |  |
| v120-release-scanner | unknown-key-38 | PASS |  |
| v120-release-scanner | unknown-key-39 | PASS |  |
| v120-release-scanner | unknown-key-40 | PASS |  |
| v120-release-scanner | unknown-key-41 | PASS |  |
| v120-release-scanner | unknown-key-42 | PASS |  |
| v120-release-scanner | unknown-key-43 | PASS |  |
| v120-release-scanner | unknown-key-44 | PASS |  |
| v120-release-scanner | unknown-key-45 | PASS |  |
| v120-release-scanner | unknown-key-46 | PASS |  |
| v120-release-scanner | unknown-key-47 | PASS |  |
| v120-release-scanner | unknown-key-48 | PASS |  |
| v120-release-scanner | unknown-key-49 | PASS |  |
| v120-release-scanner | unknown-key-50 | PASS |  |
| v120-release-scanner | unknown-key-51 | PASS |  |
| v120-release-scanner | unknown-key-52 | PASS |  |
| v120-release-scanner | unknown-key-53 | PASS |  |
| v120-release-scanner | unknown-key-54 | PASS |  |
| v120-release-scanner | unknown-key-55 | PASS |  |
| v120-release-scanner | unknown-key-56 | PASS |  |
| v120-release-scanner | unknown-key-57 | PASS |  |
| v120-release-scanner | unknown-key-58 | PASS |  |
| v120-release-scanner | unknown-key-59 | PASS |  |
| v120-release-scanner | unknown-key-60 | PASS |  |
| v120-release-scanner | unknown-key-61 | PASS |  |
| v120-release-scanner | unknown-key-62 | PASS |  |
| v120-release-scanner | unknown-key-63 | PASS |  |
| v120-release-scanner | foreign-module-00 | PASS |  |
| v120-release-scanner | foreign-module-01 | PASS |  |
| v120-release-scanner | foreign-module-02 | PASS |  |
| v120-release-scanner | foreign-module-03 | PASS |  |
| v120-release-scanner | foreign-module-04 | PASS |  |
| v120-release-scanner | foreign-module-05 | PASS |  |
| v120-release-scanner | foreign-module-06 | PASS |  |
| v120-release-scanner | foreign-module-07 | PASS |  |
| v120-release-scanner | foreign-module-08 | PASS |  |
| v120-release-scanner | foreign-module-09 | PASS |  |
| v120-release-scanner | foreign-module-10 | PASS |  |
| v120-release-scanner | foreign-module-11 | PASS |  |
| v120-release-scanner | foreign-module-12 | PASS |  |
| v120-release-scanner | foreign-module-13 | PASS |  |
| v120-release-scanner | foreign-module-14 | PASS |  |
| v120-release-scanner | foreign-module-15 | PASS |  |
| v120-release-scanner | foreign-module-16 | PASS |  |
| v120-release-scanner | foreign-module-17 | PASS |  |
| v120-release-scanner | foreign-module-18 | PASS |  |
| v120-release-scanner | foreign-module-19 | PASS |  |
| v120-release-scanner | foreign-module-20 | PASS |  |
| v120-release-scanner | foreign-module-21 | PASS |  |
| v120-release-scanner | foreign-module-22 | PASS |  |
| v120-release-scanner | foreign-module-23 | PASS |  |
| v120-release-scanner | bare-name-no-context | PASS |  |
| v120-release-scanner | unlisted-predicate-ambiguous | PASS |  |
| v120-release-scanner | diagnostic-negation-not | PASS |  |
| v120-release-scanner | wrap-property-01 | PASS |  |
| v120-release-scanner | wrap-property-02 | PASS |  |
| v120-release-scanner | wrap-property-03 | PASS |  |
| v120-release-scanner | wrap-property-04 | PASS |  |
| v120-release-scanner | wrap-property-05 | PASS |  |
| v120-release-scanner | wrap-property-06 | PASS |  |
| v120-release-scanner | wrap-property-07 | PASS |  |
| v120-release-scanner | runtime-byte-evidence_authoring.py | PASS |  |
| v120-release-scanner | runtime-byte-a2_prepare.py | PASS |  |
| v120-release-scanner | runtime-byte-a2_verify.py | PASS |  |
| v120-release-scanner | runtime-byte-evidence_store.py | PASS |  |
| v120-release-scanner | runtime-authority-ast | PASS |  |
| v120-release-scanner | receipt-ten-fields | PASS |  |
| v120-release-scanner | history-v1 | PASS |  |
| v120-release-scanner | history-v1.1 | PASS |  |
| v120-release-scanner | history-v1.2 | PASS |  |
| v120-release-scanner | history-v1.3 | PASS |  |
| v120-release-scanner | history-v1.4 | PASS |  |
| v120-release-scanner | history-v1.5 | PASS |  |
| v120-release-scanner | history-v1.6 | PASS |  |
| v120-release-scanner | history-v1.7 | PASS |  |
| v120-release-scanner | history-v1.8 | PASS |  |
| v120-release-scanner | history-v1.9 | PASS |  |
| v120-release-scanner | history-v1.10 | PASS |  |
| v120-release-scanner | history-v1.11 | PASS |  |
| v120-release-scanner | history-v1.12 | PASS |  |
| v120-release-scanner | history-v1.13 | PASS |  |
| v120-release-scanner | history-v1.14 | PASS |  |
| v120-release-scanner | history-v1.15 | PASS |  |
| v120-release-scanner | history-v1.16 | PASS |  |
| v120-release-scanner | history-v1.17 | PASS |  |
| v120-release-scanner | history-v1.18 | PASS |  |
| v120-release-scanner | history-v1.19 | PASS |  |
| v120-defect-regressions | M1-canonical-map-equals-runtime | PASS |  |
| v120-defect-regressions | M1-class-array-callable_method_set | PASS |  |
| v120-defect-regressions | M1-class-array-commit_eligibility_authorizing | PASS |  |
| v120-defect-regressions | M1-class-array-derive_attachment_state_authorizing | PASS |  |
| v120-defect-regressions | M1-class-array-derive_attachment_state_for_session | PASS |  |
| v120-defect-regressions | M1-class-array-evaluate_eligibility_authorizing | PASS |  |
| v120-defect-regressions | M1-class-array-evaluate_eligibility_for_session | PASS |  |
| v120-defect-regressions | M1-class-array-evidence_set_add_bundle_verification | PASS |  |
| v120-defect-regressions | M1-class-array-evidence_set_add_launch_recipe | PASS |  |
| v120-defect-regressions | M1-class-array-evidence_set_add_provisioning | PASS |  |
| v120-defect-regressions | M1-class-array-evidence_set_create | PASS |  |
| v120-defect-regressions | M1-class-array-evidence_set_derive_attachment_state | PASS |  |
| v120-defect-regressions | M1-class-array-evidence_set_mark_prepared | PASS |  |
| v120-defect-regressions | M1-class-array-evidence_snapshot_digest | PASS |  |
| v120-defect-regressions | M1-class-array-governed_consume | PASS |  |
| v120-defect-regressions | M1-class-array-governed_provenance_errors | PASS |  |
| v120-defect-regressions | M1-class-array-governed_structure_errors | PASS |  |
| v120-defect-regressions | M1-class-array-ingest_raw_frame | PASS |  |
| v120-defect-regressions | M1-class-array-internal_schema_errors | PASS |  |
| v120-defect-regressions | M1-class-array-load_governed_evidence_set | PASS |  |
| v120-defect-regressions | M1-class-array-location_errors | PASS |  |
| v120-defect-regressions | M1-class-array-location_receipt | PASS |  |
| v120-defect-regressions | M1-class-array-may_write | PASS |  |
| v120-defect-regressions | M1-class-array-primitive_status | PASS |  |
| v120-defect-regressions | M1-class-array-principal_errors | PASS |  |
| v120-defect-regressions | M1-class-array-promotion_state | PASS |  |
| v120-defect-regressions | M1-class-array-resolve_stored_chain | PASS |  |
| v120-defect-regressions | M1-class-array-schema_registry | PASS |  |
| v120-defect-regressions | M1-class-array-session_manifest_errors | PASS |  |
| v120-defect-regressions | M1-class-array-trusted_capture_shim | PASS |  |
| v120-defect-regressions | M1-class-array-validate_transaction_set_authorizing | PASS |  |
| v120-defect-regressions | M1-class-array-derive_attachment_state | PASS |  |
| v120-defect-regressions | M1-class-array-evaluate_eligibility | PASS |  |
| v120-defect-regressions | M1-class-array-commit_eligibility | PASS |  |
| v120-defect-regressions | M1-class-array-validate_transaction_set | PASS |  |
| v120-defect-regressions | M1-class-array-active_authority_errors | PASS |  |
| v120-defect-regressions | M1-class-array-authority_cache_stats | PASS |  |
| v120-defect-regressions | M1-class-array-canon_reference | PASS |  |
| v120-defect-regressions | M1-class-array-canon_string_reference | PASS |  |
| v120-defect-regressions | M1-class-array-capability_matrix_digest | PASS |  |
| v120-defect-regressions | M1-class-array-capability_qualification | PASS |  |
| v120-defect-regressions | M1-class-array-capture_shim_trust_errors | PASS |  |
| v120-defect-regressions | M1-class-array-classification_family | PASS |  |
| v120-defect-regressions | M1-class-array-clear_authority_caches | PASS |  |
| v120-defect-regressions | M1-class-array-codec_broad_type | PASS |  |
| v120-defect-regressions | M1-class-array-codec_contains_elision | PASS |  |
| v120-defect-regressions | M1-class-array-codec_errors | PASS |  |
| v120-defect-regressions | M1-class-array-compute_schema_registry | PASS |  |
| v120-defect-regressions | M1-class-array-compute_trusted_capture_shim | PASS |  |
| v120-defect-regressions | M1-class-array-content_digest | PASS |  |
| v120-defect-regressions | M1-class-array-content_key | PASS |  |
| v120-defect-regressions | M1-class-array-derive_capability_result | PASS |  |
| v120-defect-regressions | M1-class-array-derive_delta | PASS |  |
| v120-defect-regressions | M1-class-array-derive_delta_errors | PASS |  |
| v120-defect-regressions | M1-class-array-evidence_set_digest | PASS |  |
| v120-defect-regressions | M1-class-array-expected_effects | PASS |  |
| v120-defect-regressions | M1-class-array-governed_file_errors | PASS |  |
| v120-defect-regressions | M1-class-array-guard_lineage_errors | PASS |  |
| v120-defect-regressions | M1-class-array-guard_record_errors | PASS |  |
| v120-defect-regressions | M1-class-array-historical_schema_errors | PASS |  |
| v120-defect-regressions | M1-class-array-identity_claim_input_errors | PASS |  |
| v120-defect-regressions | M1-class-array-identity_claim_inputs | PASS |  |
| v120-defect-regressions | M1-class-array-identity_claims | PASS |  |
| v120-defect-regressions | M1-class-array-ingest_receipt_errors | PASS |  |
| v120-defect-regressions | M1-class-array-journal_applied_ops | PASS |  |
| v120-defect-regressions | M1-class-array-journal_head | PASS |  |
| v120-defect-regressions | M1-class-array-journal_readback | PASS |  |
| v120-defect-regressions | M1-class-array-occurrence_index | PASS |  |
| v120-defect-regressions | M1-class-array-parser_sha256 | PASS |  |
| v120-defect-regressions | M1-class-array-primitive_spec | PASS |  |
| v120-defect-regressions | M1-class-array-primitive_spec_digest | PASS |  |
| v120-defect-regressions | M1-class-array-profile_satisfies | PASS |  |
| v120-defect-regressions | M1-class-array-promotion_step | PASS |  |
| v120-defect-regressions | M1-class-array-raw_capture_digest | PASS |  |
| v120-defect-regressions | M1-class-array-raw_capture_digest_ok | PASS |  |
| v120-defect-regressions | M1-class-array-raw_ingest_receipt | PASS |  |
| v120-defect-regressions | M1-class-array-read_governed_file | PASS |  |
| v120-defect-regressions | M1-class-array-read_primitive_authority_digest | PASS |  |
| v120-defect-regressions | M1-class-array-required_s1_profile | PASS |  |
| v120-defect-regressions | M1-class-array-schema_registry_digest | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_commit_manifest | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_conflict | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_derived_result_record | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_identity_observation | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_journal | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_mutation_plan | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_raw_capture | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_refreeze_record | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_review_decision | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_snapshot | PASS |  |
| v120-defect-regressions | M1-class-array-semantic_verification_result | PASS |  |
| v120-defect-regressions | M1-class-array-shim_allowlist | PASS |  |
| v120-defect-regressions | M1-class-array-shim_allowlist_digest | PASS |  |
| v120-defect-regressions | M1-class-array-stored_chain_digest | PASS |  |
| v120-defect-regressions | M1-class-array-strict_parse_raw_frame | PASS |  |
| v120-defect-regressions | M1-class-array-supersession_resolve | PASS |  |
| v120-defect-regressions | M1-class-array-trusted_shim_digest | PASS |  |
| v120-defect-regressions | M1-class-array-validate_transaction_set_diagnostic | PASS |  |
| v120-defect-regressions | M1-class-array-verify_transaction | PASS |  |
| v120-defect-regressions | M1-function-key-derive_attachment_state | PASS |  |
| v120-defect-regressions | M1-function-key-derive_attachment_state_authorizing | PASS |  |
| v120-defect-regressions | M1-function-key-derive_attachment_state_for_session | PASS |  |
| v120-defect-regressions | M1-function-key-evaluate_eligibility | PASS |  |
| v120-defect-regressions | M1-function-key-evaluate_eligibility_authorizing | PASS |  |
| v120-defect-regressions | M1-function-key-evaluate_eligibility_for_session | PASS |  |
| v120-defect-regressions | M1-function-key-validate_transaction_set | PASS |  |
| v120-defect-regressions | M1-function-key-validate_transaction_set_authorizing | PASS |  |
| v120-defect-regressions | M1-function-key-commit_eligibility | PASS |  |
| v120-defect-regressions | M1-function-key-commit_eligibility_authorizing | PASS |  |
| v120-defect-regressions | M1-function-key-load_governed_evidence_set | PASS |  |
| v120-defect-regressions | M1-function-key-governed_consume | PASS |  |
| v120-defect-regressions | M1-exact-omission-00 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[0]', 'function': 'callable_method_set', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-01 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[6]', 'function': 'evidence_set_add_bundle_verification', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-02 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[7]', 'function': 'evidence_set_add_launch_recipe', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-03 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[8]', 'function': 'evidence_set_add_provisioning', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-04 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[9]', 'function': 'evidence_set_create', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-05 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[10]', 'function': 'evidence_set_derive_attachment_state', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-06 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[11]', 'function': 'evidence_set_mark_prepared', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-07 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[12]', 'function': 'evidence_snapshot_digest', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-08 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[14]', 'function': 'governed_provenance_errors', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-09 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[15]', 'function': 'governed_structure_errors', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-10 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[16]', 'function': 'ingest_raw_frame', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-11 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[17]', 'function': 'internal_schema_errors', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-12 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[19]', 'function': 'location_errors', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-13 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[20]', 'function': 'location_receipt', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-14 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[21]', 'function': 'may_write', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-15 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[22]', 'function': 'primitive_status', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-16 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[23]', 'function': 'principal_errors', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-17 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[24]', 'function': 'promotion_state', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-18 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[25]', 'function': 'resolve_stored_chain', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-19 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[26]', 'function': 'schema_registry', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-20 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[27]', 'function': 'session_manifest_errors', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-21 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'authorizing.[28]', 'function': 'trusted_capture_shim', 'role': 'AUTHORIZING_DESIGNATION', 'present': False} |
| v120-defect-regressions | M1-exact-omission-22 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.derive_attachment_state', 'function': 'derive_attachment_state', 'authority_class': 'diagnostic_non_authorizing', 'inventory_occurrences': 0 |
| v120-defect-regressions | M1-exact-omission-23 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.derive_attachment_state_authorizing', 'function': 'derive_attachment_state_authorizing', 'authority_class': 'authorizing', 'inventory_occurr |
| v120-defect-regressions | M1-exact-omission-24 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.derive_attachment_state_for_session', 'function': 'derive_attachment_state_for_session', 'authority_class': 'authorizing', 'inventory_occurr |
| v120-defect-regressions | M1-exact-omission-25 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.evaluate_eligibility', 'function': 'evaluate_eligibility', 'authority_class': 'diagnostic_non_authorizing', 'inventory_occurrences': 0} |
| v120-defect-regressions | M1-exact-omission-26 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.evaluate_eligibility_authorizing', 'function': 'evaluate_eligibility_authorizing', 'authority_class': 'authorizing', 'inventory_occurrences' |
| v120-defect-regressions | M1-exact-omission-27 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.evaluate_eligibility_for_session', 'function': 'evaluate_eligibility_for_session', 'authority_class': 'authorizing', 'inventory_occurrences' |
| v120-defect-regressions | M1-exact-omission-28 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.validate_transaction_set', 'function': 'validate_transaction_set', 'authority_class': 'provisional_until_m3_non_authorizing', 'inventory_occ |
| v120-defect-regressions | M1-exact-omission-29 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.validate_transaction_set_authorizing', 'function': 'validate_transaction_set_authorizing', 'authority_class': 'authorizing', 'inventory_occu |
| v120-defect-regressions | M1-exact-omission-30 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.commit_eligibility', 'function': 'commit_eligibility', 'authority_class': 'provisional_until_m3_non_authorizing', 'inventory_occurrences': 0 |
| v120-defect-regressions | M1-exact-omission-31 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.commit_eligibility_authorizing', 'function': 'commit_eligibility_authorizing', 'authority_class': 'authorizing', 'inventory_occurrences': 0} |
| v120-defect-regressions | M1-exact-omission-32 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.load_governed_evidence_set', 'function': 'load_governed_evidence_set', 'authority_class': 'authorizing', 'inventory_occurrences': 0} |
| v120-defect-regressions | M1-exact-omission-33 | PASS | {'artifact': 'AUTHORITY-FUNCTION-CLASSES.json', 'location': 'decision_functions.governed_consume', 'function': 'governed_consume', 'authority_class': 'authorizing', 'inventory_occurrences': 0} |
| v120-defect-regressions | M1-nested-key-value-callable_method_set | PASS |  |
| v120-defect-regressions | M1-nested-key-value-commit_eligibility_authorizing | PASS |  |
| v120-defect-regressions | M1-nested-key-value-derive_attachment_state_authorizing | PASS |  |
| v120-defect-regressions | M1-nested-key-value-derive_attachment_state_for_session | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evaluate_eligibility_authorizing | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evaluate_eligibility_for_session | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evidence_set_add_bundle_verification | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evidence_set_add_launch_recipe | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evidence_set_add_provisioning | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evidence_set_create | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evidence_set_derive_attachment_state | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evidence_set_mark_prepared | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evidence_snapshot_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-governed_consume | PASS |  |
| v120-defect-regressions | M1-nested-key-value-governed_provenance_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-governed_structure_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-ingest_raw_frame | PASS |  |
| v120-defect-regressions | M1-nested-key-value-internal_schema_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-load_governed_evidence_set | PASS |  |
| v120-defect-regressions | M1-nested-key-value-location_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-location_receipt | PASS |  |
| v120-defect-regressions | M1-nested-key-value-may_write | PASS |  |
| v120-defect-regressions | M1-nested-key-value-primitive_status | PASS |  |
| v120-defect-regressions | M1-nested-key-value-principal_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-promotion_state | PASS |  |
| v120-defect-regressions | M1-nested-key-value-resolve_stored_chain | PASS |  |
| v120-defect-regressions | M1-nested-key-value-schema_registry | PASS |  |
| v120-defect-regressions | M1-nested-key-value-session_manifest_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-trusted_capture_shim | PASS |  |
| v120-defect-regressions | M1-nested-key-value-validate_transaction_set_authorizing | PASS |  |
| v120-defect-regressions | M1-nested-key-value-derive_attachment_state | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evaluate_eligibility | PASS |  |
| v120-defect-regressions | M1-nested-key-value-commit_eligibility | PASS |  |
| v120-defect-regressions | M1-nested-key-value-validate_transaction_set | PASS |  |
| v120-defect-regressions | M1-nested-key-value-active_authority_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-authority_cache_stats | PASS |  |
| v120-defect-regressions | M1-nested-key-value-canon_reference | PASS |  |
| v120-defect-regressions | M1-nested-key-value-canon_string_reference | PASS |  |
| v120-defect-regressions | M1-nested-key-value-capability_matrix_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-capability_qualification | PASS |  |
| v120-defect-regressions | M1-nested-key-value-capture_shim_trust_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-classification_family | PASS |  |
| v120-defect-regressions | M1-nested-key-value-clear_authority_caches | PASS |  |
| v120-defect-regressions | M1-nested-key-value-codec_broad_type | PASS |  |
| v120-defect-regressions | M1-nested-key-value-codec_contains_elision | PASS |  |
| v120-defect-regressions | M1-nested-key-value-codec_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-compute_schema_registry | PASS |  |
| v120-defect-regressions | M1-nested-key-value-compute_trusted_capture_shim | PASS |  |
| v120-defect-regressions | M1-nested-key-value-content_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-content_key | PASS |  |
| v120-defect-regressions | M1-nested-key-value-derive_capability_result | PASS |  |
| v120-defect-regressions | M1-nested-key-value-derive_delta | PASS |  |
| v120-defect-regressions | M1-nested-key-value-derive_delta_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-evidence_set_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-expected_effects | PASS |  |
| v120-defect-regressions | M1-nested-key-value-governed_file_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-guard_lineage_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-guard_record_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-historical_schema_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-identity_claim_input_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-identity_claim_inputs | PASS |  |
| v120-defect-regressions | M1-nested-key-value-identity_claims | PASS |  |
| v120-defect-regressions | M1-nested-key-value-ingest_receipt_errors | PASS |  |
| v120-defect-regressions | M1-nested-key-value-journal_applied_ops | PASS |  |
| v120-defect-regressions | M1-nested-key-value-journal_head | PASS |  |
| v120-defect-regressions | M1-nested-key-value-journal_readback | PASS |  |
| v120-defect-regressions | M1-nested-key-value-occurrence_index | PASS |  |
| v120-defect-regressions | M1-nested-key-value-parser_sha256 | PASS |  |
| v120-defect-regressions | M1-nested-key-value-primitive_spec | PASS |  |
| v120-defect-regressions | M1-nested-key-value-primitive_spec_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-profile_satisfies | PASS |  |
| v120-defect-regressions | M1-nested-key-value-promotion_step | PASS |  |
| v120-defect-regressions | M1-nested-key-value-raw_capture_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-raw_capture_digest_ok | PASS |  |
| v120-defect-regressions | M1-nested-key-value-raw_ingest_receipt | PASS |  |
| v120-defect-regressions | M1-nested-key-value-read_governed_file | PASS |  |
| v120-defect-regressions | M1-nested-key-value-read_primitive_authority_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-required_s1_profile | PASS |  |
| v120-defect-regressions | M1-nested-key-value-schema_registry_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_commit_manifest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_conflict | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_derived_result_record | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_identity_observation | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_journal | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_mutation_plan | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_raw_capture | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_refreeze_record | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_review_decision | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_snapshot | PASS |  |
| v120-defect-regressions | M1-nested-key-value-semantic_verification_result | PASS |  |
| v120-defect-regressions | M1-nested-key-value-shim_allowlist | PASS |  |
| v120-defect-regressions | M1-nested-key-value-shim_allowlist_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-stored_chain_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-strict_parse_raw_frame | PASS |  |
| v120-defect-regressions | M1-nested-key-value-supersession_resolve | PASS |  |
| v120-defect-regressions | M1-nested-key-value-trusted_shim_digest | PASS |  |
| v120-defect-regressions | M1-nested-key-value-validate_transaction_set_diagnostic | PASS |  |
| v120-defect-regressions | M1-nested-key-value-verify_transaction | PASS |  |
| v120-defect-regressions | M2-no-annotation-governs eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-governs eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-governs eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-governs eligibility | PASS |  |
| v120-defect-regressions | M2-no-annotation-controls eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-controls eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-controls eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-controls eligibility | PASS |  |
| v120-defect-regressions | M2-no-annotation-is authoritative | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-is authoritative | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-is authoritative | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-is authoritative | PASS |  |
| v120-defect-regressions | M2-no-annotation-decides readiness | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-decides readiness | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-decides readiness | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-decides readiness | PASS |  |
| v120-defect-regressions | M2-no-annotation-authorizes commits | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-authorizes commits | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-authorizes commits | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-authorizes commits | PASS |  |
| v120-defect-regressions | M2-no-annotation-refuses invalid authority | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-refuses invalid authority | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-refuses invalid authority | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-refuses invalid authority | PASS |  |
| v120-defect-regressions | M2-no-annotation-determines eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-determines eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-determines eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-determines eligibility | PASS |  |
| v120-defect-regressions | M2-no-annotation-establishes authority | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-establishes authority | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-establishes authority | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-establishes authority | PASS |  |
| v120-defect-regressions | M2-no-annotation-permits eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-DIAGNOSTIC_DECLARATION-permits eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-HISTORICAL_STATEMENT-permits eligibility | PASS |  |
| v120-defect-regressions | M2-conflicting-MENTION-permits eligibility | PASS |  |
| v120-defect-regressions | M2-multiple-0f983d38b1 | PASS |  |
| v120-defect-regressions | M2-multiple-d0eed84b87 | PASS |  |
| v120-defect-regressions | M2-multiple-4501a1d37d | PASS |  |
| v120-defect-regressions | M2-multiple-2eb03b0cbf | PASS |  |
| v120-defect-regressions | M2-multiple-1f991bd783 | PASS |  |
| v120-defect-regressions | M2-benign-43afaf445d | PASS |  |
| v120-defect-regressions | M2-benign-79b95d5260 | PASS |  |
| v120-defect-regressions | M2-benign-f59b38ff90 | PASS |  |
| v120-defect-regressions | M2-malformed-authority_role | PASS |  |
| v120-defect-regressions | M2-malformed-source_sha256 | PASS |  |
| v120-defect-regressions | M2-malformed-module | PASS |  |
| v120-defect-regressions | M2-malformed-function | PASS |  |
| v120-defect-regressions | M2-malformed-unexpected | PASS |  |
| v120-defect-regressions | N1-own-clause-'; ' | PASS |  |
| v120-defect-regressions | N1-own-clause-'. ' | PASS |  |
| v120-defect-regressions | N1-own-clause-': ' | PASS |  |
| v120-defect-regressions | N1-own-clause-', ' | PASS |  |
| v120-defect-regressions | N1-own-clause-'\n' | PASS |  |
| v120-defect-regressions | N1-name-form-derive_attachment_state(a, b) | PASS |  |
| v120-defect-regressions | N1-name-form-`derive_attachment_state` | PASS |  |
| v120-defect-regressions | N1-name-form-authority_lib.derive_attachment_state | PASS |  |
| v120-defect-regressions | N1-name-form-tools/authority_lib.py#derive_attachment_state | PASS |  |
| v120-defect-regressions | N2-history-S18 | PASS |  |
| v120-defect-regressions | N2-history-S28 | PASS |  |
| v120-defect-regressions | N2-history-S32 | PASS |  |
| v120-defect-regressions | N2-history-S37 | PASS |  |
| v120-defect-regressions | N2-history-S61 | PASS |  |
| v120-defect-regressions | N3-current-target-version | PASS |  |
| v120-defect-regressions | N3-current-milestone-version | PASS |  |
| v120-defect-regressions | N1-law-precedence | PASS |  |
| v120-defect-regressions | M3-M4-all-primitive-sdk-contracts | PASS | [] |
| v120-defect-regressions | M3-source-optional-property-dict | PASS |  |
| v120-defect-regressions | M4-source-name-int-epoch | PASS |  |
| v120-defect-regressions | GetClipProperty-READ_PRIMITIVE_QUALIFICATION_PROBE-wrong-receiver | PASS |  |
| v120-defect-regressions | GetClipProperty-READ_PRIMITIVE_QUALIFICATION_PROBE-wrong-expected_type | PASS |  |
| v120-defect-regressions | GetProjectLastModifiedTime-READ_PRIMITIVE_QUALIFICATION_PROBE-wrong-receiver | PASS |  |
| v120-defect-regressions | GetProjectLastModifiedTime-READ_PRIMITIVE_QUALIFICATION_PROBE-wrong-arg_types | PASS |  |
| v120-defect-regressions | GetProjectLastModifiedTime-READ_PRIMITIVE_QUALIFICATION_PROBE-wrong-expected_type | PASS |  |
| v120-defect-regressions | GetClipProperty-SNAPSHOT_CAPTURE-wrong-receiver | PASS |  |
| v120-defect-regressions | GetClipProperty-SNAPSHOT_CAPTURE-wrong-expected_type | PASS |  |
| v120-defect-regressions | GetProjectLastModifiedTime-TRIPWIRE_READ-wrong-receiver | PASS |  |
...
| stored-chain | attached-evidence-duplicate-current-review: refused, and the refusal names the substituted link | PASS | REVIEW: 2 current candidates (d4b22399e934, ef054dc0b2c9); an explicit supersession is required and insertion order never decides; REVIEW_CONFLICT: no single cu |
...
| stored-chain | attached-evidence-duplicate-current-refreeze: refused, and the refusal names the substituted link | PASS | REFREEZE: 2 current candidates (7b298eee42d2, cd8e353b11b0); an explicit supersession is required and insertion order never decides; REFREEZE_CONFLICT: no singl |
...
| evidence-boundary-receipt | ALTERNATE ROOT (Codex S110-1, pinned): the same session basename copied under another root is refused ROOT_IDENTITY_MISMATCH. v1.9 verified it clean. | PASS | ROOT_IDENTITY_MISMATCH: opened under '<TMPDIR>/resolve-evidence-<TMPDIR>/ROOT-B' but the receipt was established under '<TMPDIR>/resol |
...
| evidence-boundary-fields | F110-A pinned: receipt field authority_version (FROZEN_CONSTANT) rewritten with a recomputed boundary_sha256 refuses the next canonical operation. v1.10 accepted schema, evidence_store_version, authority_version and platform_scope. | PASS | BOUNDARY_RECEIPT_INVALID: authority_version='1.10.0' is not the frozen FROZEN_CONSTANT '1.20.0' of this ev |
...
| m0a-binding | published authority_version is the value this bundle actually implements | PASS | published=1.20.0 actual=1.20.0 |
| m0a-binding | published capture_allowlist_digest is the value this bundle actually implements | PASS | published=ead63126d6e4032f2854f16d actual=<SHA256> |
...
| m0a-binding | published evidence_store_sha256 is the value this bundle actually implements | PASS | published=6364535417489c26e2f0911a actual=<SHA256> |
...
| m0a-binding | published primitive_spec_sha256 is the value this bundle actually implements | PASS | published=2bb2612672562e90f75d1de3 actual=<SHA256> |
...
| m0a-binding | published reference_parser_sha256 is the value this bundle actually implements | PASS | published=01a39890a27deecdefd4b173 actual=<SHA256> |
...
| m0a-binding | published schema_registry_sha256 is the value this bundle actually implements | PASS | published=4b7e03cbbdff89a0f6faf19c actual=<SHA256> |
| m0a-binding | published trusted_shim_sha256 is the value this bundle actually implements | PASS | published=caf310438232c65d010942a4 actual=<SHA256> |
| m0a-binding | published trusted_shim_source_sha256 is the value this bundle actually implements | PASS | published=4132e5bd30339d68cd80c2bb actual=<SHA256> |
