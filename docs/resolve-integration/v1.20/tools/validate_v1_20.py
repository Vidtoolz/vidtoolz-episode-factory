...
Run: python3 -B tools/validate_v1_19.py
"""
import ast
import copy
import glob
...
# v1.19 (V116-B1 / Codex section 55.5): every artifact is registered with a STATUS and a published ROLE, so audits
...
rec("precedence", "the v1.5 through v1.16 changelogs and finding matrices are HISTORICAL; the v1.20 ones are active", all(st_.get(d_) == "HISTORICAL" for d_ in ("CHANGELOG-v1.5.md", "FINDING-RESOLUTION-MATRIX-v1.5.md", "CHANGELOG-v1.6.md", "FINDING-RESOLUTION-MATRIX-v1.6.md", "CHANGELOG-v1.7.md", "FINDING-RESOLUTION-MATRIX-v1.7.md", "CHANGELOG-v1.8.md", "FINDING-RESOLUTION-MATRIX-v1.8.md", "CHANGELOG-v1.9.md", "FINDING-RESOLUTION-MATRIX-v1.9.md", "CHANGELOG-v1.10.md", "FINDING-RESOLUTION-MATRIX-v1.10.md", "CHANGELOG-v1.11.md", "FINDING-RESOLUTION-MATRIX-v1.11.md", "CHANGELOG-v1.12.md", "FINDING-RESOLUTION-MATRIX-v1.12.md", "CHANGELOG-v1.13.md", "FINDING-RESOLUTION-MATRIX-v1.13.md", "CHANGELOG-v1.14.md", "FINDING-RESOLUTION-MATRIX-v1.14.md", "CHANGELOG-v1.15.md", "FINDING-RESOLUTION-MATRIX-v1.15.md", "CHANGELOG-v1.16.md", "FINDING-RESOLUTION-MATRIX-v1.16.md", "CHANGELOG-v1.17.md", "FINDING-RESOLUTION-MATRIX-v1.17.md", "CHANGELOG-v1.18.md", "FINDING-RESOLUTION-MATRIX-v1.18.md", "CHANGELOG-v1.19.md", "FINDING-RESOLUTION-MATRIX-v1.19.md")) and st_.get("CHANGELOG-v1.20.md") == "STILL_ACTIVE" and st_.get("FINDING-RESOLUTION-MATRIX-v1.20.md") == "STILL_ACTIVE")
...
# v1.19: every artifact is now registered in precedence with a STATUS and a ROLE, so this audit can say exactly what
...
if os.path.exists(man_path):
    ...
    parent = L.strict_load(os.path.join(os.path.dirname(B), "v1.19", "FREEZE-MANIFEST.json"))
    ...
    rec("manifest", "the parent block records the v1.19 branch HEAD and its semantic commit, which for v1.19 are the same commit because its bundle and registration were committed together (section 29)", man["parent"]["head"] == "5efbcae6a36b76d4a359f3e65e503336576575c7" and man["parent"]["semantic_head"] == "5efbcae6a36b76d4a359f3e65e503336576575c7" and man["parent"]["manifest_sha256"] == "06811f07b422d1cdf30ae6c076bae2bc0b598fc3ac464a0e180a8553a76a2848" and man["parent"]["version"] == "1.19.0" and {a["version"] for a in man["parent"]["ancestors"]} >= {"1.15.0", "1.14.0", "1.13.0"})
...
try:
    ...
    # v1.19 (V116-B1): this regression is now evaluated by tools/authority_slots.py - clause-local, structured,
...
# ---- v1.19 (V116-B1): slots are DISCOVERED, not read from a hand-written dictionary. The v1.16 inventory listed
...
# v1.19 replaces publication-scanner assertions; protected runtime/receipt checks remain below.
SLOT_ROWS=SLOTS.references(B)
SLOT_VIOLATIONS=SLOTS.violations(SLOT_ROWS)
SLOT_AUTH=SLOTS.slots(SLOT_ROWS)
_auth_slot_bad=SLOT_VIOLATIONS
_diag_slot_bad=SLOT_VIOLATIONS
_claim_bad=[]
rec("current-reference-classes", "all current references classified without ambiguous or demoted authority", not SLOT_VIOLATIONS, str(SLOT_VIOLATIONS[:1]))
...
# ================================================================ 23. v1.19: Codex's sole v1.16 finding
...
# v1.19 scanner and release regressions are in a bounded tooling-only module.
import v120_tests
...
_check_ids=[]
_id_occurrences={}
for sec,name,ok,detail in R:
    base=sec+":"+hashlib.sha256(name.encode()).hexdigest()
    _id_occurrences[base]=_id_occurrences.get(base,0)+1
    _check_ids.append(base+":"+str(_id_occurrences[base]))
if "--author-record-check-plan" in sys.argv:
    with open(os.path.join(B,"REQUIRED-VALIDATION-CHECKS.json"),"w") as f:
        json.dump({"schema":"vidtoolz.resolveRequiredValidationChecks.v1","authority_version":L.AUTHORITY_VERSION,"role":"AUTHOR_FROZEN_CHECK_PLAN","check_ids":_check_ids},f,indent=2);f.write("\n")
    print("AUTHOR CHECK PLAN RECORDED; THIS MODE DOES NOT VALIDATE OR APPROVE")
    sys.exit(2)
_required=load("REQUIRED-VALIDATION-CHECKS.json")['check_ids']
rec("required-check-plan", "actual check IDs equal required check IDs", not RELEASE.required_errors(_check_ids,_required), RELEASE.required_errors(_check_ids,_required))
...
# v1.19 (V116-B1 section 18): the slot inventory is GENERATED here, from the current artifacts, by the same module
# the audits use. It is machine authority for consumers and evidence for reviewers, and never hand-maintained.

lines = ["# VALIDATION REPORT — Resolve authority bundle v1.20", "", f"Result: **{passed}/{total} checks passed**. IMPLEMENTATION AUTHOR self-validation; independent review required. Offline synthetic tests only; no operational A2/A2V/A1/A3 execution. Protected runtime tests retained; scanner/release assertions replaced as documented in REQUIRED-VALIDATION-CHECKS.json.", "", "| Finding | Sections | Checks | Passed |", "|---|---|---|---|"]
