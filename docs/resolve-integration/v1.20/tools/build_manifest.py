...
_p17 = L.strict_load(os.path.join(os.path.dirname(B), 'v1.19', 'FREEZE-MANIFEST.json'))
_out = os.path.join(B, 'FREEZE-MANIFEST.json')
_m18 = m
_m18['parent'] = dict(_p17['parent'])
_m18['parent'].update(version='1.19.0', branch='docs/resolve-authority-freeze-v1.19', head='5efbcae6a36b76d4a359f3e65e503336576575c7', semantic_head='5efbcae6a36b76d4a359f3e65e503336576575c7', manifest_sha256='06811f07b422d1cdf30ae6c076bae2bc0b598fc3ac464a0e180a8553a76a2848', immutable=True)
