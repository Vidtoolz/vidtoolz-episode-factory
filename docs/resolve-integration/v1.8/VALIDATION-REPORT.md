...
| C16-M3 append-only evidence store not executable (M0A MAJOR) | evidence-store | 29 | 29 |
| C16-OP1 Hermes M0A binding values not operationally closed | m0a-binding, codex-matrix | 29 | 29 |
...
| R7 F15-07 / M-PRECEDENCE transaction lifecycle precedence | precedence, precedence-supersession, precedence-retired-terms | 125 | 125 |
...
| evidence-single-authority | 7 | 7 |
| evidence-store | 29 | 29 |
| evidence-traversal | 8 | 8 |
| exact-manifest | 8 | 8 |
| f64-exact | 2 | 2 |
...
| evidence-set-schema-negative | attached-evidence-raised-fake-parse-block | PASS | additionalProperties:records/14ed47632bf4e07181b5c52cd41a17b70d029fc5f953fde578d9baede80c8954/capture:Additional properties are not allowed ('parse', 'result' were unexpected) |
| evidence-set-binding-negative | attached-evidence-raised-fake-parse-block | PASS | 14ed47632bf4: capture carries forbidden interpretation field 'parse'; 14ed47632bf4: capture carries forbidden interpretation field 'result' |
| evidence-set-schema | attached-evidence-raw-tampered | PASS |  |
| evidence-set-binding-negative | attached-evidence-raw-tampered | PASS | 01feab136924: capture raw_digest does not re-hash; 098d5790bc19: capture raw_digest does not re-hash |
...
| evidence-set-schema-negative | attached-evidence-review-stale-parser | PASS | const:records/02a73b291cf045f7e8e208e633892a1f1d506b8d9b914aeb23dcc4b85c48a355/parser_version:'vidtoolz.resolveProbeParser.v1' was expected |
...
| evidence-set-binding-negative | attached-fatal-probe-failure | PASS | 0388bb1c4096: capture binding library_root disagrees with envelope/contract/active authority; 0388bb1c4096: capture binding library_uuid disagrees with envelope/contract/active authority |
...
| evidence-set-binding-negative | invalid-bundle-other-manifest-not-historical | PASS | c0196bb79ed4: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema | invalid-connection-other-authority | PASS |  |
| evidence-set-binding-negative | invalid-connection-other-authority | PASS | 9c4797d33238: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.8.0 |
| evidence-set-schema | invalid-connection-wrong-manifest | PASS |  |
| evidence-set-binding-negative | invalid-connection-wrong-manifest | PASS | c29fc5c06c5b: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema-negative | invalid-provisioning-without-root | PASS | not:records/d0282bfd37502398c6f8e1c01d85c7241a1dbc49c15cf73e588cc122ad29dcd1/envelope/library_root:None should not be valid under {'type': 'null'} |
| evidence-set-binding-negative | invalid-provisioning-without-root | PASS | d0282bfd3750: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY |
| evidence-set-schema-negative | invalid-retired-capability-evidence-type | PASS | enum:records/fa5a894cbacfa51d17eb2c04830842a314db24d1812479020301dbf63af750a1/record_type:'CAPABILITY_EVIDENCE' is not one of ['BUNDLE_VERIFICATION', 'CONNECTION_OBSERVATION', 'DERIVED_CAPABILITY_RESULT', 'DESTINATION_TI |
| evidence-set-binding-negative | invalid-retired-capability-evidence-type | PASS | fa5a894cbacf: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review) |
| evidence-set-schema | invalid-tampered-record | PASS |  |
| evidence-set-binding-negative | invalid-tampered-record | PASS | 80802fb53a72: record_id does not match content digest |
...
| evidence-ref-negative | uppercase sha | PASS | M3_AUTHORIZATION: reference is not a sha256 ('571C7238769822DF11A3FF8D0C2B5B7BFBB1DC27F72CBDB80701D35868B8DB34') |
| evidence-ref-negative | unlinked sha | PASS | M3_AUTHORIZATION: referenced record 999999999999 not in evidence set |
| evidence-ref-negative | wrong type | PASS | M3_AUTHORIZATION: record 571c72387698 has type PROVISIONING_RECORD |
| evidence-ref-negative | short hex | PASS | M3_AUTHORIZATION: reference is not a sha256 ('571c7238769822df11a3ff8d0c2b5b7bfbb1dc27f72cbdb80701d35868b8db3') |
| evidence-ref-negative | sha with newline | PASS | M3_AUTHORIZATION: reference is not a sha256 ('571c7238769822df11a3ff8d0c2b5b7bfbb1dc27f72cbdb80701d35868b8db34\n') |
...
| attachment-derived | attached-evidence-raised-fake-parse-block -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', "14ed47632bf4: capture carries forbidden interpretation field 'parse'"] conflicts=[] |
| attachment-derived | attached-evidence-raw-tampered -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '01feab136924: capture raw_digest does not re-hash'] conflicts=[] |
...
| attachment-derived | attached-fatal-probe-failure -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '0388bb1c4096: capture binding library_root disagrees with envelope/contract/active authority'] conflicts=[] |
...
| attachment-derived | invalid-bundle-other-manifest-not-historical -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'c0196bb79ed4: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-connection-other-authority -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '9c4797d33238: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.8.0'] conflicts=[] |
| attachment-derived | invalid-connection-wrong-manifest -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'c29fc5c06c5b: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-provisioning-without-root -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'd0282bfd3750: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY'] conflicts=[] |
| attachment-derived | invalid-retired-capability-evidence-type -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'fa5a894cbacf: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review)'] conflicts=[] |
| attachment-derived | invalid-tampered-record -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '80802fb53a72: record_id does not match content digest'] conflicts=[] |
...
| refreeze-law | a refreeze from another session is refused | PASS | GetSourceStartFrame: raw capture from another probe/session |
| refreeze-law | a refreeze from another probe run is refused | PASS | GetSourceStartFrame: raw capture from another probe/session |
...
| fixture-schema-negative | plan-authority-version-old | PASS | const:authority_version:'1.8.0' was expected |
| fixture-schema-positive | plan-digest-not-of-body | PASS |  |
| fixture-semantic-negative | plan-digest-not-of-body | PASS | plan_digest does not match plan body digest; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != '000 |
| fixture-schema-positive | plan-duplicate-operation-id | PASS |  |
| fixture-semantic-negative | plan-duplicate-operation-id | PASS | operation ids must be unique and non-empty; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != 'b941 |
| fixture-schema-positive | plan-eligible-without-prepared-journal | PASS |  |
| fixture-eligibility-negative | plan-eligible-without-prepared-journal | PASS | operation APPEND not eligible: ['JOURNAL_PREPARED (JOURNAL_PREPARED: referenced record eb9bb8ed1754 not in evidence set)', 'PLAN_VALIDATED (PLAN_VALIDATION: referenced record 6cf1c0cc4396 not in evidence set)', 'GUARD_CU |
...
| fixture-semantic-negative | plan-operation-set-digest-mismatch | PASS | operation_set_digest does not match operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != ' |
| fixture-schema-positive | plan-plan-validation-record-fail | PASS |  |
| fixture-eligibility-negative | plan-plan-validation-record-fail | PASS | operation APPEND not eligible: ['PLAN_VALIDATED (PLAN_VALIDATION: referenced record 6cf1c0cc4396 not in evidence set)'] |
| fixture-schema-positive | plan-read-class-with-append | PASS |  |
| fixture-semantic-negative | plan-read-class-with-append | PASS | RESOLVE_READ permission class cannot carry write operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da6 |
| fixture-schema-positive | plan-selector-target-mismatch | PASS |  |
| fixture-semantic-negative | plan-selector-target-mismatch | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != 'beb2ac24dd70d822d45e6aac2a7931e22bcc6449f22925cf |
| fixture-schema-positive | plan-session-not-current | PASS |  |
| fixture-semantic-negative | plan-session-not-current | PASS | plan session_id != evidence set current_session_id (execution session mismatch); operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c008260 |
| fixture-schema-positive | plan-stale-guard | PASS |  |
| fixture-semantic-negative | plan-stale-guard | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != '90fd73bcd35036c727208a2c58de3610c26fa9ea21457c42 |
...
| linked-set-negative | linked-set-effect-not-specified-claims-verified | PASS | plan: operation SET_PROPERTIES not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != '53352328d4c6217f0460fec6c9a94b4861 |
...
| eligibility | m0-deny-ref-wrong-record-type | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['READ_ONLY_JOURNAL_OPEN (READ_ONLY_JOURNAL: record 80802fb53a72 has type CONNECTION_OBSERVATION)'] codes=['PREREQUISITES_FAILED'] |
...
| eligibility | m3-append-deny-authorization-old-authority | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record 9e158fd350e9 not in evidence set)', 'TARGET_STATE_SCRATCH_WRITE_READY (no M3_AUTHORIZATION  |
...
| eligibility | m3-save-deny-ids-unavailable | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT failed=['M2_EXIT_EVIDENCE (MILESTONE_EXIT: referenced record a7284a87782f not in evidence set)', 'MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record 9e158fd350e |
...
| eligibility | m3-append-deny-h0-minimal-m0 | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != 'd4d6530122d |
| eligibility-request-schema | m3-append-deny-h0-full-timeline-read | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-full-timeline-read | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != 'b9c79e36680 |
| eligibility-request-schema | m3-append-deny-h0-incomplete-write-precheck | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-incomplete-write-precheck | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != '9fe62b9dbd2 |
| eligibility-request-schema | m3-append-deny-h0-candidate-provenance | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-candidate-provenance | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != 'c18b4f7e9eb |
| eligibility-request-schema | m3-append-deny-h0-other-matrix | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-matrix | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != '3c8631d6de9 |
| eligibility-request-schema | m3-append-deny-h0-other-target | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-target | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record eb9bb8ed1754 plan_digest='450d0a00691eec385707f5540570b0c00826094848db21204933a9da631f55df' != '70bbf2afc6b |
...
| eligibility | m3-append-deny-plan-validation-from-helper | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["PLAN_VALIDATED (PLAN_VALIDATION: record 0bfb6f58a1d4 validator='tools/authority_lib.py#semantic_mutation_plan' != 'tools/authority_lib.py#validate_tra |
...
| precedence | the v1.5, v1.6 and v1.7 changelogs and finding matrices are HISTORICAL; the v1.8 ones are active | PASS |  |
| precedence | the four v1.7 correction laws are retained as STILL_ACTIVE with supersession statements S39-S45 | PASS |  |
| precedence | the v1.8 evidence-store supersessions S46-S47 are recorded and EVIDENCE-ROOT.md is the single STILL_ACTIVE store document | PASS |  |
...
| manifest | parent (v1.7) manifest sha pinned | PASS |  |
| manifest | grandparent (v1.6) manifest sha pinned | PASS |  |
| manifest | the parent block records BOTH the v1.7 branch HEAD it was cut from and the inherited v1.7 SEMANTIC commit (section 26) | PASS |  |
| manifest | v1.0-v1.7 bundles are byte-identical to their frozen manifests (history preserved) | PASS |  |
...
| stored-chain | attached-evidence-duplicate-current-review: refused, and the refusal names the substituted link | PASS | REVIEW: 2 current candidates (a6311e4a8696, c93ce8733b78); an explicit supersession is required and insertion order never decides; REVIEW_CONFLICT: no single cu |
...
| stored-chain | attached-evidence-duplicate-current-refreeze: refused, and the refusal names the substituted link | PASS | REFREEZE: 2 current candidates (4bf9014824d8, 59bab066e7a1); an explicit supersession is required and insertion order never decides; REFREEZE_CONFLICT: no singl |
...
| evidence-store | the session manifest pins the active authority, registry, matrix, trusted shim, parser and primitive spec | PASS |  |
| evidence-store | a session manifest with a wrong authority_manifest_sha256 is refused | PASS |  |
| evidence-store | a session manifest with a wrong trusted_shim_sha256 is refused | PASS |  |
| evidence-store | a session manifest with a wrong parser_sha256 is refused | PASS |  |
| evidence-store | a session manifest with a wrong primitive_spec_sha256 is refused | PASS |  |
| evidence-store | a session manifest with a wrong schema_registry_sha256 is refused | PASS |  |
| evidence-store | a session manifest with a wrong codec_version is refused | PASS |  |
| evidence-store | a session manifest with a wrong evidence_store_version is refused | PASS |  |
| evidence-store | a session manifest with a wrong evidence_inventory_schema is refused | PASS |  |
| evidence-store | a session manifest with a wrong stdout_retention is refused | PASS |  |
| evidence-store | the session manifest names the v1.8 store, session and inventory schemas | PASS |  |
| evidence-store | a session directory is created once and can never be created again | PASS |  |
| evidence-store | a brand new session reports state ACTIVE | PASS |  |
| evidence-store | a record is stored at a path derived from the sha256 of the bytes the store hashed itself | PASS |  |
| evidence-store | re-putting byte-identical content under the same attempt id is idempotent, not an overwrite | PASS |  |
| evidence-store | a caller-declared digest is compared and never trusted | PASS |  |
| evidence-store | the same attempt id with different bytes is refused (section 16) | PASS |  |
| evidence-store | an unknown layer is refused | PASS |  |
| evidence-store | DERIVED, HUMAN_REVIEW and AUTHORITY_PROMOTION take content plus a logical identity and the store derives the content-addressed destination (sections 5/6) | PASS |  |
| evidence-store | finalization writes a self-digesting closed-world inventory and a FINALIZED marker naming it | PASS |  |
| evidence-store | a finalized session reports state FINALIZED | PASS |  |
| evidence-store | after finalization the session is immutable: every write API and re-finalization refuse (section 10) | PASS |  |
| evidence-store | the pinned authority of a finalized session is re-checkable and refuses a mismatched active authority | PASS |  |
| evidence-store | the store never opens an existing record for writing, truncates, renames over one or unlinks a final record | PASS |  |
| evidence-store | the store implements the four EVIDENCE-ROOT layers and a closed refusal vocabulary | PASS |  |
| evidence-store | content addressing is retained: every verification recomputes the bytes and compares to the name (section 15) | PASS |  |
| evidence-store | an unfinalized session reports ACTIVE and has no inventory | PASS |  |
| evidence-store | a partially written record makes the session PARTIAL, is reported, and blocks finalization (section 18) | PASS |  |
| evidence-store | a crashed session can never report FINALIZED, and the four states are closed | PASS |  |
| evidence-closed-world | control: the untouched finalized session verifies clean | PASS |  |
| evidence-closed-world | the inventory records path, kind, layer, digest, byte count, schema type, logical identity and attempt ids for every entry, plus the expected directory set (section 8/9) | PASS |  |
| evidence-closed-world | STORE-14 (Codex, pinned regression): finalize a valid session, plant an unexpected file in the session ROOT, verify -> UNEXPECTED_ENTRY. v1.7 ignored this file and returned no errors. | PASS | UNEXPECTED_ENTRY: PLANTED-BY-ATTACKER.json is present on disk but not in the finalized inventory |
| evidence-closed-world | removing the planted file restores a clean verification (the refusal was the file, not a latch) | PASS |  |
| evidence-closed-world | post-finalization: an unexpected file in the session root invalidates the session (UNEXPECTED_ENTRY) | PASS | UNEXPECTED_ENTRY: EXTRA-ROOT.json is present on disk but not in the finalized inventory |
| evidence-closed-world | post-finalization: an unexpected nested file inside a layer invalidates the session (UNEXPECTED_ENTRY) | PASS | UNEXPECTED_ENTRY: RAW/EXTRA-NESTED.json is present on disk but not in the finalized inventory |
| evidence-closed-world | post-finalization: an unexpected file in a record shard directory invalidates the session (UNEXPECTED_ENTRY) | PASS | EVIDENCE_REPLACED: RAW/02/EXTRA-SHARD.json holds 60f97c7b5bf55c5f186c5d1c79c8e3b6929c83bf2766434df9f1e1b9069db73a |
| evidence-closed-world | post-finalization: an unexpected directory invalidates the session (UNEXPECTED_ENTRY) | PASS | UNEXPECTED_ENTRY: directory EXTRA-DIR is present on disk but not in the finalized inventory |
| evidence-closed-world | post-finalization: an unexpected nested directory invalidates the session (UNEXPECTED_ENTRY) | PASS | UNEXPECTED_ENTRY: directory DERIVED/EXTRA-DIR is present on disk but not in the finalized inventory |
| evidence-closed-world | post-finalization: an unexpected file in the attempts index invalidates the session (UNEXPECTED_ENTRY) | PASS | UNEXPECTED_ENTRY: ATTEMPTS/forged-attempt is present on disk but not in the finalized inventory |
| evidence-closed-world | after every planted entry is removed the session verifies clean again | PASS |  |
| evidence-closed-world | post-finalization: an extra RAW record that is correctly content-addressed is still UNEXPECTED_ENTRY | PASS | UNEXPECTED_ENTRY: RAW/f6/f6a93d7c8354387b463d70a0b1290fa2dfcb375d108096e2d85ac3414c378e2d.json is present on disk but not in the finalized inventory |
| evidence-closed-world | post-finalization: an extra DERIVED record that is correctly content-addressed is still UNEXPECTED_ENTRY | PASS | UNEXPECTED_ENTRY: DERIVED/72/72fa96b53c017d12bb01f217fdba2fcad5432496405d2ca8a5db3b1da1eebaab.json is present on disk but not in the finalized invento |
| evidence-closed-world | post-finalization: altering the bytes of a stored record is EVIDENCE_REPLACED | PASS | EVIDENCE_REPLACED: AUTHORITY_PROMOTION/16/166d35e0df19ca5b8a62282fce6ed9a8ac22d8f011a2a475ca52a7ac193c6705.json byte count 17 != inventory 16 |
| evidence-closed-world | restoring the exact bytes makes the session verify again | PASS |  |
| evidence-closed-world | post-finalization: deleting a stored record is RECORD_MISSING | PASS | RECORD_MISSING: AUTHORITY_PROMOTION/16/166d35e0df19ca5b8a62282fce6ed9a8ac22d8f011a2a475ca52a7ac193c6705.json is recorded in the inventory but absent o |
| evidence-closed-world | post-finalization: renaming a stored record is BOTH a missing entry and an unexpected one | PASS | RECORD_MISSING: AUTHORITY_PROMOTION/16/166d35e0df19ca5b8a62282fce6ed9a8ac22d8f011a2a475ca52a7ac193c6705.json is recorded in the inventory but absent on disk; UNEXPECTED_E |
| evidence-closed-world | restoring the record under its own name verifies again | PASS |  |
| evidence-closed-world | post-finalization: altering the inventory is INVENTORY_TAMPERED | PASS | INVENTORY_TAMPERED: inventory_sha256 is not the digest of this inventory |
| evidence-closed-world | post-finalization: altering the finalization receipt is INVENTORY_TAMPERED | PASS | INVENTORY_TAMPERED: FINALIZED marker does not name this inventory |
| evidence-closed-world | the finalized session verifies clean after every attack is reverted, and the inventory digest is unchanged | PASS |  |
| evidence-closed-world | a symlink planted inside a finalized session is SYMLINK_REJECTED (section 13: no symlink may exist anywhere in an evidence session) | PASS | SYMLINK_REJECTED: PLANTED-SYMLINK.json |
| evidence-closed-world | a symlinked DIRECTORY planted inside a finalized session is rejected and never followed | PASS |  |
| evidence-closed-world | a FIFO planted inside a finalized session is FILE_TYPE_REJECTED (section 14) | PASS | FILE_TYPE_REJECTED: MODE_0o10000 at PLANTED-FIFO |
| evidence-closed-world | the session verifies clean once every non-regular entry is removed | PASS |  |
| evidence-closed-world | verification walks the tree without following symlinks | PASS |  |
| evidence-single-authority | exactly one module in this bundle is classified EVIDENCE_STORE_AUTHORIZING | PASS |  |
| evidence-single-authority | the legacy EvidenceRoot surface is GONE from the capture shim (Codex ES-2) | PASS |  |
| evidence-single-authority | the capture shim contains no storage primitive at all: no directory creation, no exclusive create, no hard link, no layer path | PASS |  |
| evidence-single-authority | the capture shim names the one store module and disclaims storage authority (section 19) | PASS |  |
| evidence-single-authority | no module other than the store defines a session-creating, record-writing, finalizing or verifying entry point | PASS |  |
| evidence-single-authority | the store's write API accepts no filesystem path: every signature takes a layer/attempt id/logical identity and bytes | PASS |  |
| evidence-single-authority | only the store module contains the append-only write primitive | PASS |  |
| evidence-traversal | every one of 20 traversal / absolute / separator / dot / empty / over-long identifier shapes is refused by all eight store entry points (160 refusals) | PASS | accepted:  |
| evidence-traversal | no file appeared anywhere outside the session root during the whole traversal battery (section 24) | PASS |  |
| evidence-traversal | the exact legacy attack EvidenceRoot.add_derived('../../...') has no API left to call, and the canonical equivalent refuses before any write | PASS |  |
| evidence-traversal | a derived payload whose CONTENT contains a traversal string is stored harmlessly, because content never becomes a path | PASS |  |
| evidence-traversal | containment is proven on the RESOLVED path, not by a string prefix check | PASS |  |
| evidence-traversal | the logical-name gate rejects empty, dot, dot-dot, separators, NUL, leading dot and over-long names | PASS |  |
| evidence-traversal | a symlinked session name is refused at open (section 13) | PASS |  |
| evidence-traversal | a symlink planted inside a layer cannot be traversed through, and blocks finalization | PASS |  |
...
| codex-matrix | the ACTIVE v1.8 finding-resolution matrix enumerates exactly the two Codex v1.7 evidence-store ids | PASS |  |
| codex-matrix | ES-1: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 55 checks; failing=[] |
| codex-matrix | ES-2: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 15 checks; failing=[] |
| m0a-binding | every Hermes M0A binding value is published and none is a placeholder | PASS |  |
| m0a-binding | published authority_version is the value this bundle actually implements | PASS | published=1.8.0 actual=1.8.0 |
...
| m0a-binding | published evidence_store_sha256 is the value this bundle actually implements | PASS | published=1bd63dc4924f4f972272c855 actual=1bd63dc4924f4f972272c855 |
...
| m0a-binding | published raw_schema_version is the value this bundle actually implements | PASS | published=1.8 actual=1.8 |
...
| m0a-binding | published schema_registry_sha256 is the value this bundle actually implements | PASS | published=4aa55490dda56622bcdbdb63 actual=4aa55490dda56622bcdbdb63 |
