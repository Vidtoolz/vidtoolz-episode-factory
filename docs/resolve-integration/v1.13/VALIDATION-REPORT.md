...
| C16-OP1 Hermes M0A binding values not operationally closed | m0a-binding, codex-matrix | 38 | 38 |
...
| R7 F15-07 / M-PRECEDENCE transaction lifecycle precedence | precedence, precedence-supersession, precedence-retired-terms | 167 | 167 |
...
| evidence-set-binding-negative | attached-evidence-raised-fake-parse-block | PASS | 1205b1c7d1e5: capture carries forbidden interpretation field 'parse'; 1205b1c7d1e5: capture carries forbidden interpretation field 'result' |
| evidence-set-schema | attached-evidence-raw-tampered | PASS |  |
| evidence-set-binding-negative | attached-evidence-raw-tampered | PASS | 0126545498d6: capture raw_digest does not re-hash; 072f27832f70: capture raw_digest does not re-hash |
...
| evidence-set-binding-negative | attached-fatal-probe-failure | PASS | f53bb24e5ba0: capture binding library_root disagrees with envelope/contract/active authority; f53bb24e5ba0: capture binding library_uuid disagrees with envelope/contract/active authority |
...
| evidence-set-binding-negative | invalid-bundle-other-manifest-not-historical | PASS | 2515b9697a77: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema | invalid-connection-other-authority | PASS |  |
| evidence-set-binding-negative | invalid-connection-other-authority | PASS | bce7ea1651d9: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.13.0 |
| evidence-set-schema | invalid-connection-wrong-manifest | PASS |  |
| evidence-set-binding-negative | invalid-connection-wrong-manifest | PASS | 3e20f120daae: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest |
...
| evidence-set-binding-negative | invalid-provisioning-without-root | PASS | 4deef0b344de: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY |
...
| evidence-set-binding-negative | invalid-retired-capability-evidence-type | PASS | 2d7c85249c53: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review) |
| evidence-set-schema | invalid-tampered-record | PASS |  |
| evidence-set-binding-negative | invalid-tampered-record | PASS | 0cf433ba5d57: record_id does not match content digest |
...
| evidence-ref-negative | uppercase sha | PASS | M3_AUTHORIZATION: reference is not a sha256 ('8121B50DDC0C3BAC0686D1E2CDC3637BF3CFB9C3DC4D9C446933ED77C582C238') |
| evidence-ref-negative | unlinked sha | PASS | M3_AUTHORIZATION: referenced record 999999999999 not in evidence set |
| evidence-ref-negative | wrong type | PASS | M3_AUTHORIZATION: record 8121b50ddc0c has type PROVISIONING_RECORD |
| evidence-ref-negative | short hex | PASS | M3_AUTHORIZATION: reference is not a sha256 ('8121b50ddc0c3bac0686d1e2cdc3637bf3cfb9c3dc4d9c446933ed77c582c23') |
...
| attachment-derived | attached-evidence-raised-fake-parse-block -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', "1205b1c7d1e5: capture carries forbidden interpretation field 'parse'"] conflicts=[] |
| attachment-derived | attached-evidence-raw-tampered -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '0126545498d6: capture raw_digest does not re-hash'] conflicts=[] |
...
| attachment-derived | attached-fatal-probe-failure -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'f53bb24e5ba0: capture binding library_root disagrees with envelope/contract/active authority'] conflicts=[] |
...
| attachment-derived | invalid-bundle-other-manifest-not-historical -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '2515b9697a77: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-connection-other-authority -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'bce7ea1651d9: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.13.0'] conflicts=[] |
| attachment-derived | invalid-connection-wrong-manifest -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '3e20f120daae: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-provisioning-without-root -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '4deef0b344de: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY'] conflicts=[] |
| attachment-derived | invalid-retired-capability-evidence-type -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '2d7c85249c53: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review)'] conflicts=[] |
| attachment-derived | invalid-tampered-record -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '0cf433ba5d57: record_id does not match content digest'] conflicts=[] |
...
| refreeze-law | a refreeze from another session is refused | PASS | GetProjectManager: raw capture from another probe/session |
| refreeze-law | a refreeze from another probe run is refused | PASS | GetProjectManager: raw capture from another probe/session |
...
| fixture-schema-negative | plan-authority-version-old | PASS | const:authority_version:'1.13.0' was expected |
| fixture-schema-positive | plan-digest-not-of-body | PASS |  |
| fixture-semantic-negative | plan-digest-not-of-body | PASS | plan_digest does not match plan body digest; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 270d7 |
| fixture-schema-positive | plan-duplicate-operation-id | PASS |  |
| fixture-semantic-negative | plan-duplicate-operation-id | PASS | operation ids must be unique and non-empty; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 270d7d |
| fixture-schema-positive | plan-eligible-without-prepared-journal | PASS |  |
| fixture-eligibility-negative | plan-eligible-without-prepared-journal | PASS | operation APPEND not eligible: ['JOURNAL_PREPARED (JOURNAL_PREPARED: referenced record e31b224c8501 not in evidence set)', 'PLAN_VALIDATED (PLAN_VALIDATION: referenced record 270d7d5f9167 not in evidence set)', 'GUARD_CU |
...
| fixture-semantic-negative | plan-operation-set-digest-mismatch | PASS | operation_set_digest does not match operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 27 |
| fixture-schema-positive | plan-plan-validation-record-fail | PASS |  |
| fixture-eligibility-negative | plan-plan-validation-record-fail | PASS | operation APPEND not eligible: ['PLAN_VALIDATED (PLAN_VALIDATION: referenced record 270d7d5f9167 not in evidence set)'] |
| fixture-schema-positive | plan-read-class-with-append | PASS |  |
| fixture-semantic-negative | plan-read-class-with-append | PASS | RESOLVE_READ permission class cannot carry write operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATI |
| fixture-schema-positive | plan-selector-target-mismatch | PASS |  |
| fixture-semantic-negative | plan-selector-target-mismatch | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 270d7d5f9167 plan_digest='<SHA256>' != '<SHA256>') |
| fixture-schema-positive | plan-session-not-current | PASS |  |
| fixture-semantic-negative | plan-session-not-current | PASS | plan session_id != evidence set current_session_id (execution session mismatch); operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALI |
| fixture-schema-positive | plan-stale-guard | PASS |  |
| fixture-semantic-negative | plan-stale-guard | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 270d7d5f9167 plan_digest='<SHA256>' != '<SHA256>') |
...
| linked-set-negative | linked-set-effect-not-specified-claims-verified | PASS | plan: operation SET_PROPERTIES not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record 270d7d5f9167 plan_digest='<SHA256>'  |
...
| eligibility | m0-deny-ref-wrong-record-type | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['READ_ONLY_JOURNAL_OPEN (READ_ONLY_JOURNAL: record 0cf433ba5d57 has type CONNECTION_OBSERVATION)'] codes=['PREREQUISITES_FAILED'] |
...
| eligibility | m3-append-deny-authorization-old-authority | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record c797c6a57e6e not in evidence set)', 'TARGET_STATE_SCRATCH_WRITE_READY (no M3_AUTHORIZATION  |
...
| eligibility | m3-save-deny-ids-unavailable | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT failed=['M2_EXIT_EVIDENCE (MILESTONE_EXIT: referenced record 3afd4cf490d4 not in evidence set)', 'MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record c797c6a57e6 |
...
| eligibility | m3-append-deny-h0-minimal-m0 | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_PROFILE: snapshot profile 'MINIMAL_ |
| eligibility-request-schema | m3-append-deny-h0-full-timeline-read | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-full-timeline-read | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_PROFILE: snapshot profile 'FULL_TIM |
| eligibility-request-schema | m3-append-deny-h0-incomplete-write-precheck | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-incomplete-write-precheck | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_INCOMPLETE: guarded snapshot is not |
| eligibility-request-schema | m3-append-deny-h0-candidate-provenance | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-candidate-provenance | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_PROVENANCE: Folder.GetUniqueId is C |
| eligibility-request-schema | m3-append-deny-h0-other-matrix | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-matrix | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_MATRIX: guarded snapshot collected  |
| eligibility-request-schema | m3-append-deny-h0-other-target | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-target | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record e31b224c8501 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_TARGET: guarded snapshot identity d |
...
| eligibility | m3-append-deny-plan-validation-from-helper | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["PLAN_VALIDATED (PLAN_VALIDATION: record 067ab5e43891 validator='tools/authority_lib.py#semantic_mutation_plan' != 'tools/authority_lib.py#validate_tra |
...
| precedence-retired-terms | CHANGELOG-v1.13.md | PASS |  |
...
| precedence-retired-terms | FINDING-RESOLUTION-MATRIX-v1.13.md | PASS |  |
...
| precedence | the v1.5 through v1.12 changelogs and finding matrices are HISTORICAL; the v1.13 ones are active | PASS |  |
...
| precedence | the v1.13 governed-root supersession S60 is recorded and the v1.13 changelog and matrix are active | PASS |  |
...
| manifest | parent (v1.12) manifest sha pinned | PASS |  |
| manifest | grandparent (v1.11) manifest sha pinned | PASS |  |
...
| manifest | the parent block records the v1.12 branch HEAD and its semantic commit, which for v1.12 are the same commit because its bundle and registration were committed together (section 38) | PASS |  |
| manifest | v1.0-v1.12 bundles are byte-identical to their frozen manifests (history preserved) | PASS |  |
...
| root-law | V112-RP1 section 6: the root is classified by lstat BEFORE anything is resolved, and realpath is only ever a later alias check | PASS |  |
...
| root-static | no symlink-follow-before-check: the module never calls .resolve() and realpath appears only after lstat classification | PASS |  |
...
| stored-chain | attached-evidence-duplicate-current-review: refused, and the refusal names the substituted link | PASS | REVIEW: 2 current candidates (49cb520be890, eac1be7161b0); an explicit supersession is required and insertion order never decides; REVIEW_CONFLICT: no single cu |
...
| stored-chain | attached-evidence-duplicate-current-refreeze: refused, and the refusal names the substituted link | PASS | REFREEZE: 2 current candidates (70f0714d5aea, d503858a364e); an explicit supersession is required and insertion order never decides; REFREEZE_CONFLICT: no singl |
...
| evidence-boundary-fields | F110-A pinned: receipt field authority_version (FROZEN_CONSTANT) rewritten with a recomputed boundary_sha256 refuses the next canonical operation. v1.10 accepted schema, evidence_store_version, authority_version and platform_scope. | PASS | BOUNDARY_RECEIPT_INVALID: authority_version='1.10.0' is not the frozen FROZEN_CONSTANT '1.13.0' of this ev |
...
| codex-matrix | Store.v5 carries NO semantic change in v1.13: evidence_store.py differs from the v1.12 bundle by exactly one comment line and every semantic constant is identical | PASS | one comment line |
...
| codex-matrix | the ACTIVE v1.13 finding-resolution matrix enumerates exactly the one governed-root finding | PASS |  |
| codex-matrix | the v1.13 matrix records the WORKFLOW_CONTRADICTORY classification, the frozen v1.12 reproduction head and the protected-surface promise | PASS |  |
...
| codex-matrix | V112-RP1: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 37 checks; failing=[] |
| m0a-binding | every Hermes M0A binding value is published and none is a placeholder | PASS |  |
| m0a-binding | published authority_version is the value this bundle actually implements | PASS | published=1.13.0 actual=1.13.0 |
...
| m0a-binding | published evidence_store_sha256 is the value this bundle actually implements | PASS | published=787152ce76ff494a10c55e65 actual=787152ce76ff494a10c55e65 |
...
| m0a-binding | published schema_registry_sha256 is the value this bundle actually implements | PASS | published=bb8df984696f65850a3f2001 actual=bb8df984696f65850a3f2001 |
