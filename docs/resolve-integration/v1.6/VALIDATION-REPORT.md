...
| R7 F15-07 / M-PRECEDENCE transaction lifecycle precedence | precedence, precedence-supersession, precedence-retired-terms | 106 | 106 |
...
| evidence-set-binding | 81 | 81 |
| evidence-set-binding-negative | 9 | 9 |
| evidence-set-schema | 86 | 86 |
...
| evidence-set-schema-negative | attached-evidence-raised-fake-parse-block | PASS | additionalProperties:records/00c5c2208f744c820769d8c1e1c61245d94748c9da2f9d3e91d92d9fae114963/capture:Additional properties are not allowed ('parse', 'result' were unexpected) |
| evidence-set-binding-negative | attached-evidence-raised-fake-parse-block | PASS | 00c5c2208f74: capture carries forbidden interpretation field 'parse'; 00c5c2208f74: capture carries forbidden interpretation field 'result' |
| evidence-set-schema | attached-evidence-raw-tampered | PASS |  |
| evidence-set-binding-negative | attached-evidence-raw-tampered | PASS | 00cb6b55d498: capture raw_digest does not re-hash; 0518f78e0e3f: capture raw_digest does not re-hash |
...
| evidence-set-schema-negative | attached-evidence-review-stale-parser | PASS | const:records/0538d5c82d73c911fdcb1b864489de77db1c083259cd88af657feba2c8fb5ce4/parser_version:'vidtoolz.resolveProbeParser.v1' was expected |
...
| evidence-set-binding-negative | attached-fatal-probe-failure | PASS | b027b01a500c: capture binding library_root disagrees with envelope/contract/active authority; b027b01a500c: capture binding library_uuid disagrees with envelope/contract/active authority |
...
| evidence-set-binding-negative | invalid-bundle-other-manifest-not-historical | PASS | 3abf45b07e4b: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema | invalid-connection-other-authority | PASS |  |
| evidence-set-binding-negative | invalid-connection-other-authority | PASS | d98f5af51701: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.6.0 |
| evidence-set-schema | invalid-connection-wrong-manifest | PASS |  |
| evidence-set-binding-negative | invalid-connection-wrong-manifest | PASS | b6da82b4f38e: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema-negative | invalid-provisioning-without-root | PASS | not:records/23763530247e9c9e18544e8504e482f2aa8920f00d11d57e6f6cc679d604feb6/envelope/library_root:None should not be valid under {'type': 'null'} |
| evidence-set-binding-negative | invalid-provisioning-without-root | PASS | 23763530247e: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY |
| evidence-set-schema-negative | invalid-retired-capability-evidence-type | PASS | enum:records/988d12f93f428bb7879959bac9bc7035cf090daaf7c3c06fec99e4de856b7527/record_type:'CAPABILITY_EVIDENCE' is not one of ['BUNDLE_VERIFICATION', 'CONNECTION_OBSERVATION', 'DERIVED_CAPABILITY_RESULT', 'DESTINATION_TI |
| evidence-set-binding-negative | invalid-retired-capability-evidence-type | PASS | 988d12f93f42: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review) |
| evidence-set-schema | invalid-tampered-record | PASS |  |
| evidence-set-binding-negative | invalid-tampered-record | PASS | 94780738a652: record_id does not match content digest |
...
| evidence-ref-negative | uppercase sha | PASS | M3_AUTHORIZATION: reference is not a sha256 ('69A0A2C554D79B9BFC86358F056BEBB6B060BDC081DABC39310671E5B72BF675') |
| evidence-ref-negative | unlinked sha | PASS | M3_AUTHORIZATION: referenced record 999999999999 not in evidence set |
| evidence-ref-negative | wrong type | PASS | M3_AUTHORIZATION: record 69a0a2c554d7 has type PROVISIONING_RECORD |
| evidence-ref-negative | short hex | PASS | M3_AUTHORIZATION: reference is not a sha256 ('69a0a2c554d79b9bfc86358f056bebb6b060bdc081dabc39310671e5b72bf67') |
| evidence-ref-negative | sha with newline | PASS | M3_AUTHORIZATION: reference is not a sha256 ('69a0a2c554d79b9bfc86358f056bebb6b060bdc081dabc39310671e5b72bf675\n') |
...
| attachment-derived | attached-evidence-raised-fake-parse-block -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', "00c5c2208f74: capture carries forbidden interpretation field 'parse'"] conflicts=[] |
| attachment-derived | attached-evidence-raw-tampered -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '00cb6b55d498: capture raw_digest does not re-hash'] conflicts=[] |
...
| attachment-derived | attached-fatal-probe-failure -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'b027b01a500c: capture binding library_root disagrees with envelope/contract/active authority'] conflicts=[] |
...
| attachment-derived | invalid-bundle-other-manifest-not-historical -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '3abf45b07e4b: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-connection-other-authority -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'd98f5af51701: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.6.0'] conflicts=[] |
| attachment-derived | invalid-connection-wrong-manifest -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'b6da82b4f38e: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-provisioning-without-root -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '23763530247e: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY'] conflicts=[] |
| attachment-derived | invalid-retired-capability-evidence-type -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '988d12f93f42: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review)'] conflicts=[] |
| attachment-derived | invalid-tampered-record -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '94780738a652: record_id does not match content digest'] conflicts=[] |
...
| raw-vs-fake-parse | timeout + ACCEPT review -> UNQUALIFIED (derived TIMEOUT or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
| raw-vs-fake-parse | attribute missing + ACCEPT review -> UNQUALIFIED (derived UNSUPPORTED or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
| raw-vs-fake-parse | wrong type + ACCEPT review -> UNQUALIFIED (derived TYPE_MISMATCH or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
| raw-vs-fake-parse | null + ACCEPT review -> UNQUALIFIED (derived NULL_NOT_ALLOWED or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
| raw-vs-fake-parse | truncated + ACCEPT review -> UNQUALIFIED (derived TRUNCATED or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
| raw-vs-fake-parse | unserializable + ACCEPT review -> UNQUALIFIED (derived UNSERIALIZABLE or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
| raw-vs-fake-parse | tampered raw + ACCEPT review -> UNQUALIFIED (derived MALFORMED or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
| raw-vs-fake-parse | wrong receiver + ACCEPT review -> UNQUALIFIED (derived RECEIVER_MISMATCH or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
| raw-vs-fake-parse | wrong build/session + ACCEPT review -> UNQUALIFIED (derived BINDING_MISMATCH or unresolvable evidence) | PASS | status=UNQUALIFIED reasons=['raw capture missing, malformed, unbound or ambiguous'] |
...
| identity-evidence | duplicate ids: A true, B FALSE with the duplicate listed, C true (callability never implies uniqueness) | PASS |  |
...
| fixture-schema-negative | plan-authority-version-old | PASS | const:authority_version:'1.6.0' was expected |
| fixture-schema-positive | plan-digest-not-of-body | PASS |  |
| fixture-semantic-negative | plan-digest-not-of-body | PASS | plan_digest does not match plan body digest; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '000 |
| fixture-schema-positive | plan-duplicate-operation-id | PASS |  |
| fixture-semantic-negative | plan-duplicate-operation-id | PASS | operation ids must be unique and non-empty; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '5625 |
| fixture-schema-positive | plan-eligible-without-prepared-journal | PASS |  |
| fixture-eligibility-negative | plan-eligible-without-prepared-journal | PASS | operation APPEND not eligible: ['JOURNAL_PREPARED (JOURNAL_PREPARED: referenced record ebeb62e3690f not in evidence set)', 'PLAN_VALIDATED (PLAN_VALIDATION: referenced record 52b67ef09519 not in evidence set)', 'GUARD_CU |
...
| fixture-semantic-negative | plan-operation-set-digest-mismatch | PASS | operation_set_digest does not match operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != ' |
| fixture-schema-positive | plan-plan-validation-record-fail | PASS |  |
| fixture-eligibility-negative | plan-plan-validation-record-fail | PASS | operation APPEND not eligible: ['PLAN_VALIDATED (PLAN_VALIDATION: referenced record 52b67ef09519 not in evidence set)'] |
| fixture-schema-positive | plan-read-class-with-append | PASS |  |
| fixture-semantic-negative | plan-read-class-with-append | PASS | RESOLVE_READ permission class cannot carry write operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065e |
| fixture-schema-positive | plan-selector-target-mismatch | PASS |  |
| fixture-semantic-negative | plan-selector-target-mismatch | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '99aa9193fdfb8b6fd2047891b39b2770d89a22a115def677 |
| fixture-schema-positive | plan-session-not-current | PASS |  |
| fixture-semantic-negative | plan-session-not-current | PASS | plan session_id != evidence set current_session_id (execution session mismatch); operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612 |
| fixture-schema-positive | plan-stale-guard | PASS |  |
| fixture-semantic-negative | plan-stale-guard | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '49c9779eec3d7087a6151abbfbc81af50704e2c17aaecea3 |
...
| fixture-snapshot-negative | snapshot-provenance-cites-failed-evidence | PASS | method_provenance[GetClipEnabled]: primitive is not QUALIFIED_CALLABLE under the active capability matrix (raw capture missing, malformed, unbound or ambiguous); method_provenance[GetCurrentTimeline]: primitive is not QU |
...
| fixture-snapshot-negative | snapshot-provenance-cites-raised-accepted-evidence | PASS | method_provenance[GetClipEnabled]: primitive is not QUALIFIED_CALLABLE under the active capability matrix (raw capture missing, malformed, unbound or ambiguous); method_provenance[GetCurrentTimeline]: primitive is not QU |
| fixture-schema-positive | snapshot-provenance-cites-unreviewed-evidence | PASS |  |
| fixture-snapshot-negative | snapshot-provenance-cites-unreviewed-evidence | PASS | method_provenance[GetClipEnabled]: primitive is not QUALIFIED_CALLABLE under the active capability matrix (no reviewed REFREEZE_RECORD for the active matrix promotes exactly this raw/deri); method_provenance[GetCurrentTi |
...
| linked-set-negative | linked-set-effect-not-specified-claims-verified | PASS | plan: operation SET_PROPERTIES not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '337ef1334b12ea0b155cf76a5c37b8439a |
...
| bypass-audit | schema_validate is a REQUIRED positional parameter of both authorizing entry points (F15-04: no default makes schema enforcement optional) | PASS |  |
| bypass-audit | the default (no schema validator) composed call refuses instead of reporting the schema stage completed | PASS |  |
...
| eligibility | m0-deny-ref-wrong-record-type | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['READ_ONLY_JOURNAL_OPEN (READ_ONLY_JOURNAL: record 94780738a652 has type CONNECTION_OBSERVATION)'] codes=['PREREQUISITES_FAILED'] |
...
| eligibility | m3-append-deny-authorization-old-authority | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record 5c0f01527e21 not in evidence set)', 'TARGET_STATE_SCRATCH_WRITE_READY (no M3_AUTHORIZATION  |
...
| eligibility | m3-save-deny-ids-unavailable | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT failed=['M2_EXIT_EVIDENCE (MILESTONE_EXIT: referenced record 91ad0f1788b1 not in evidence set)', 'MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record 5c0f01527e2 |
...
| eligibility | m3-append-deny-h0-minimal-m0 | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '8c49adf30fc |
| eligibility-request-schema | m3-append-deny-h0-full-timeline-read | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-full-timeline-read | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != 'f6bd96f3499 |
| eligibility-request-schema | m3-append-deny-h0-incomplete-write-precheck | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-incomplete-write-precheck | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '2635f562365 |
| eligibility-request-schema | m3-append-deny-h0-candidate-provenance | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-candidate-provenance | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '34ec4e596da |
| eligibility-request-schema | m3-append-deny-h0-other-matrix | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-matrix | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != '11199fad695 |
| eligibility-request-schema | m3-append-deny-h0-other-target | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-target | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record ebeb62e3690f plan_digest='15a8ca00372fa5d2061a55a232aa29dd12612486d36179c7b6cee065ed514b8b' != 'd504304d827 |
...
| eligibility | m3-append-deny-plan-validation-from-helper | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["PLAN_VALIDATED (PLAN_VALIDATION: record 9caee62731a4 validator='tools/authority_lib.py#semantic_mutation_plan' != 'tools/authority_lib.py#validate_tra |
...
| order-independence | attachment: 90 evidence sets x 4 record-map permutations give identical derivations | PASS |  |
...
| precedence | v1.5 changelog and finding matrix are HISTORICAL; v1.6 ones are active | PASS |  |
...
| precedence | SCORECRAFT-EXTRACTION.md cites v1.6 active schemas, not earlier ones | PASS |  |
...
| manifest | parent (v1.5) manifest sha pinned | PASS |  |
| manifest | v1.0-v1.5 bundles are byte-identical to their frozen manifests (history preserved) | PASS |  |
