...
Run after validate_v1_7.py (so VALIDATION-REPORT.md is current): python3 -B tools/build_manifest.py
...
PARENT_HEAD = "82976433875c8a68aff13f2d9a4071e913b8da29"
PARENT_MANIFEST = "9f8a1a2e51f205409f8cb3f175144d21c59658221a42398612f982746a04ac29"
...
parent = L.strict_load(os.path.join(V16, "FREEZE-MANIFEST.json"))
...
NOTES = {
    ...
    "fixtures/evidence/ACTIVE-AUTHORITY-PLACEHOLDER.json": ("fixture evidence is minted against this PLACEHOLDER manifest sha; validate_v1_7.py proves placeholder-bound records do not derive against the real FREEZE-MANIFEST.json sha and that re-minted records do", None),
    ...
    "tools/evidence_store.py": ("TOOL (v1.7, C16-M3): the executable append-only evidence store - the EVIDENCE-ROOT law as running code. Exercised only against temporary directories by the validator; no M0 evidence root exists", "M0"),
}
...
m = {"schema": "vidtoolz.resolveFreezeManifest.v1.7", "bundle": "docs/resolve-integration/v1.7", "version": "1.7.0", "frozen_at": "2026-09-09", "prepared_by": "Claude Code (Fable 5.1)", "approval_status": "CANDIDATE_FOR_INDEPENDENT_REVIEW", "approver": None,
     "parent": {"version": "1.6.0", "branch": "docs/resolve-authority-freeze-v1.6", "head": PARENT_HEAD, "manifest_sha256": PARENT_MANIFEST, "immutable": True,
                "ancestors": [
