...
| C16-M3 append-only evidence store not executable (M0A MAJOR) | evidence-store | 27 | 27 |
| C16-OP1 Hermes M0A binding values not operationally closed | m0a-binding, codex-matrix | 25 | 25 |
...
| R7 F15-07 / M-PRECEDENCE transaction lifecycle precedence | precedence, precedence-supersession, precedence-retired-terms | 117 | 117 |
...
| evidence-set-schema-negative | attached-evidence-raised-fake-parse-block | PASS | additionalProperties:records/04a365a7a5487411b844ee5a992f966def6cec2eb31a811708ca18ee8155a877/capture:Additional properties are not allowed ('parse', 'result' were unexpected) |
| evidence-set-binding-negative | attached-evidence-raised-fake-parse-block | PASS | 04a365a7a548: capture carries forbidden interpretation field 'parse'; 04a365a7a548: capture carries forbidden interpretation field 'result' |
| evidence-set-schema | attached-evidence-raw-tampered | PASS |  |
| evidence-set-binding-negative | attached-evidence-raw-tampered | PASS | 149c99e20fcd: capture raw_digest does not re-hash; 1c5489eff3e3: capture raw_digest does not re-hash |
...
| evidence-set-schema-negative | attached-evidence-review-stale-parser | PASS | const:records/01e5cd5890f0669c14faabd39f8eb1532e31536122ff06c443235a9af6b4e93d/parser_version:'vidtoolz.resolveProbeParser.v1' was expected |
...
| evidence-set-binding-negative | attached-fatal-probe-failure | PASS | 26a2afe3dcdb: capture binding library_root disagrees with envelope/contract/active authority; 26a2afe3dcdb: capture binding library_uuid disagrees with envelope/contract/active authority |
...
| evidence-set-binding-negative | invalid-bundle-other-manifest-not-historical | PASS | cc617be28590: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema | invalid-connection-other-authority | PASS |  |
| evidence-set-binding-negative | invalid-connection-other-authority | PASS | 95bb0ac2fad7: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.7.0 |
| evidence-set-schema | invalid-connection-wrong-manifest | PASS |  |
| evidence-set-binding-negative | invalid-connection-wrong-manifest | PASS | d18384254b7c: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema-negative | invalid-provisioning-without-root | PASS | not:records/a59aa984c9c38709a2c198efff78eed275fc66d069f9ab4d83aed303fb4f4a18/envelope/library_root:None should not be valid under {'type': 'null'} |
| evidence-set-binding-negative | invalid-provisioning-without-root | PASS | a59aa984c9c3: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY |
| evidence-set-schema-negative | invalid-retired-capability-evidence-type | PASS | enum:records/0be1c0fb280f83b030bf942c60f2114eeb484ca8d81103ff784c4759080ba20e/record_type:'CAPABILITY_EVIDENCE' is not one of ['BUNDLE_VERIFICATION', 'CONNECTION_OBSERVATION', 'DERIVED_CAPABILITY_RESULT', 'DESTINATION_TI |
| evidence-set-binding-negative | invalid-retired-capability-evidence-type | PASS | 0be1c0fb280f: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review) |
| evidence-set-schema | invalid-tampered-record | PASS |  |
| evidence-set-binding-negative | invalid-tampered-record | PASS | cdb68c1c40d7: record_id does not match content digest |
...
| evidence-ref-negative | uppercase sha | PASS | M3_AUTHORIZATION: reference is not a sha256 ('E5B933CB4B59837F1D6B21A6FB9482258B471BFE81E18E6932D2B8DB4B925960') |
| evidence-ref-negative | unlinked sha | PASS | M3_AUTHORIZATION: referenced record 999999999999 not in evidence set |
| evidence-ref-negative | wrong type | PASS | M3_AUTHORIZATION: record e5b933cb4b59 has type PROVISIONING_RECORD |
| evidence-ref-negative | short hex | PASS | M3_AUTHORIZATION: reference is not a sha256 ('e5b933cb4b59837f1d6b21a6fb9482258b471bfe81e18e6932d2b8db4b92596') |
| evidence-ref-negative | sha with newline | PASS | M3_AUTHORIZATION: reference is not a sha256 ('e5b933cb4b59837f1d6b21a6fb9482258b471bfe81e18e6932d2b8db4b925960\n') |
...
| attachment-derived | attached-evidence-raised-fake-parse-block -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', "04a365a7a548: capture carries forbidden interpretation field 'parse'"] conflicts=[] |
| attachment-derived | attached-evidence-raw-tampered -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '149c99e20fcd: capture raw_digest does not re-hash'] conflicts=[] |
...
| attachment-derived | attached-fatal-probe-failure -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '26a2afe3dcdb: capture binding library_root disagrees with envelope/contract/active authority'] conflicts=[] |
...
| attachment-derived | invalid-bundle-other-manifest-not-historical -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'cc617be28590: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-connection-other-authority -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '95bb0ac2fad7: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.7.0'] conflicts=[] |
| attachment-derived | invalid-connection-wrong-manifest -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'd18384254b7c: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-provisioning-without-root -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'a59aa984c9c3: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY'] conflicts=[] |
| attachment-derived | invalid-retired-capability-evidence-type -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '0be1c0fb280f: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review)'] conflicts=[] |
| attachment-derived | invalid-tampered-record -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'cdb68c1c40d7: record_id does not match content digest'] conflicts=[] |
...
| refreeze-law | a refreeze from another session is refused | PASS | GetMediaPoolItem: raw capture from another probe/session |
| refreeze-law | a refreeze from another probe run is refused | PASS | GetMediaPoolItem: raw capture from another probe/session |
...
| fixture-schema-negative | plan-authority-version-old | PASS | const:authority_version:'1.7.0' was expected |
| fixture-schema-positive | plan-digest-not-of-body | PASS |  |
| fixture-semantic-negative | plan-digest-not-of-body | PASS | plan_digest does not match plan body digest; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != '000 |
| fixture-schema-positive | plan-duplicate-operation-id | PASS |  |
| fixture-semantic-negative | plan-duplicate-operation-id | PASS | operation ids must be unique and non-empty; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != 'fbcb |
| fixture-schema-positive | plan-eligible-without-prepared-journal | PASS |  |
| fixture-eligibility-negative | plan-eligible-without-prepared-journal | PASS | operation APPEND not eligible: ['JOURNAL_PREPARED (JOURNAL_PREPARED: referenced record 1100cf3b4405 not in evidence set)', 'PLAN_VALIDATED (PLAN_VALIDATION: referenced record d81b5352a29f not in evidence set)', 'GUARD_CU |
...
| fixture-semantic-negative | plan-operation-set-digest-mismatch | PASS | operation_set_digest does not match operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != ' |
| fixture-schema-positive | plan-plan-validation-record-fail | PASS |  |
| fixture-eligibility-negative | plan-plan-validation-record-fail | PASS | operation APPEND not eligible: ['PLAN_VALIDATED (PLAN_VALIDATION: referenced record d81b5352a29f not in evidence set)'] |
| fixture-schema-positive | plan-read-class-with-append | PASS |  |
| fixture-semantic-negative | plan-read-class-with-append | PASS | RESOLVE_READ permission class cannot carry write operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c |
| fixture-schema-positive | plan-selector-target-mismatch | PASS |  |
| fixture-semantic-negative | plan-selector-target-mismatch | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != 'b82b37106acca9b6727be11a7a51506849f62d40e5d5af75 |
| fixture-schema-positive | plan-session-not-current | PASS |  |
| fixture-semantic-negative | plan-session-not-current | PASS | plan session_id != evidence set current_session_id (execution session mismatch); operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e |
| fixture-schema-positive | plan-stale-guard | PASS |  |
| fixture-semantic-negative | plan-stale-guard | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != '2c266e990c21a172468bc0f7fe5b0a69b3e1154078ce4998 |
...
| linked-set-negative | linked-set-effect-not-specified-claims-verified | PASS | plan: operation SET_PROPERTIES not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != '349143bbc405df0c9d87a574b92265f645 |
...
| eligibility | m0-deny-ref-wrong-record-type | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['READ_ONLY_JOURNAL_OPEN (READ_ONLY_JOURNAL: record cdb68c1c40d7 has type CONNECTION_OBSERVATION)'] codes=['PREREQUISITES_FAILED'] |
...
| eligibility | m3-append-deny-authorization-old-authority | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record d2001e43c654 not in evidence set)', 'TARGET_STATE_SCRATCH_WRITE_READY (no M3_AUTHORIZATION  |
...
| eligibility | m3-save-deny-ids-unavailable | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT failed=['M2_EXIT_EVIDENCE (MILESTONE_EXIT: referenced record 5b0cbdb8523a not in evidence set)', 'MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record d2001e43c65 |
...
| eligibility | m3-append-deny-h0-minimal-m0 | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != '2629f09cfe5 |
| eligibility-request-schema | m3-append-deny-h0-full-timeline-read | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-full-timeline-read | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != '5cf5555e7b6 |
| eligibility-request-schema | m3-append-deny-h0-incomplete-write-precheck | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-incomplete-write-precheck | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != 'dc1f08bc967 |
| eligibility-request-schema | m3-append-deny-h0-candidate-provenance | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-candidate-provenance | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != 'd21dfc9c879 |
| eligibility-request-schema | m3-append-deny-h0-other-matrix | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-matrix | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != 'eba36beb53f |
| eligibility-request-schema | m3-append-deny-h0-other-target | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-target | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 1100cf3b4405 plan_digest='663a0299ec31b501d845a987fa8fe0b760f3e8abefbeb1d42fd8ff94c45b3ace' != 'd5bc912568a |
...
| eligibility | m3-append-deny-plan-validation-from-helper | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["PLAN_VALIDATED (PLAN_VALIDATION: record 5035ab6285d7 validator='tools/authority_lib.py#semantic_mutation_plan' != 'tools/authority_lib.py#validate_tra |
...
| precedence | the v1.5 and v1.6 changelogs and finding matrices are HISTORICAL; the v1.7 ones are active | PASS |  |
| precedence | the four v1.7 correction laws are STILL_ACTIVE documents with supersession statements S39-S45 | PASS |  |
...
| precedence | SCORECRAFT-EXTRACTION.md cites v1.7 active schemas, not earlier ones | PASS |  |
...
| manifest | parent (v1.6) manifest sha pinned | PASS |  |
| manifest | grandparent (v1.5) manifest sha pinned | PASS |  |
| manifest | v1.0-v1.6 bundles are byte-identical to their frozen manifests (history preserved) | PASS |  |
...
| shim-trust | a capture from the same shim version with changed code is refused by the trusted-shim law and derives SHIM_UNTRUSTED | PASS | SHIM_UNTRUSTED: capture_shim_sha256 3f9a31534ed0... is not the trusted caf310438232... |
...
| stored-chain | attached-evidence-duplicate-current-review: refused, and the refusal names the substituted link | PASS | REVIEW: 2 current candidates (66a1fa4fb5f3, d27ca335dbf4); an explicit supersession is required and insertion order never decides; REVIEW_CONFLICT: no single cu |
...
| stored-chain | attached-evidence-duplicate-current-refreeze: refused, and the refusal names the substituted link | PASS | REFREEZE: 2 current candidates (4948cb8e6067, 801bea883fdb); an explicit supersession is required and insertion order never decides; REFREEZE_CONFLICT: no singl |
...
| evidence-store | the same attempt id with different bytes is refused | PASS |  |
| evidence-store | a path traversal in the attempt id is refused before any file is touched | PASS |  |
| evidence-store | a symlinked session name is refused | PASS |  |
| evidence-store | finalization writes a HASHES manifest that is the digest of itself and a FINALIZED marker naming it | PASS |  |
| evidence-store | after finalization the session is immutable: every further write is refused | PASS |  |
...
| evidence-store | replacing the bytes of a stored record is detected as EVIDENCE_REPLACED | PASS | EVIDENCE_REPLACED: RAW/7e1640fab7b60e5a0ebac1dbfea677f47e8549bd8265728f854ddbbc84d78f3c byte count 1271 != 1270 |
| evidence-store | restoring the exact bytes makes the session verify again | PASS |  |
| evidence-store | tampering with HASHES.json is detected | PASS |  |
| evidence-store | removing a record that HASHES lists is detected as RECORD_MISSING | PASS |  |
| evidence-store | the restored record verifies again | PASS |  |
| evidence-store | an unfinalized session is reported as not finalized and has no HASHES manifest | PASS |  |
| evidence-store | a partially written temp file is reported and blocks finalization | PASS |  |
| evidence-store | the store never opens an existing record for writing, truncates, renames over one or unlinks one | PASS |  |
| evidence-store | the executable store implements the four EVIDENCE-ROOT layers and a closed refusal vocabulary | PASS |  |
...
| codex-matrix | the v1.7 finding-resolution matrix enumerates exactly the seven Codex v1.6 ids | PASS |  |
| codex-matrix | C16-B1: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 22 checks; failing=[] |
| codex-matrix | C16-B2: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 28 checks; failing=[] |
| codex-matrix | C16-B3: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 12 checks; failing=[] |
| codex-matrix | C16-B4: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 16 checks; failing=[] |
| codex-matrix | C16-M1: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 8 checks; failing=[] |
| codex-matrix | C16-M2: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 34 checks; failing=[] |
| codex-matrix | C16-M3: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 27 checks; failing=[] |
| m0a-binding | every Hermes M0A binding value is published and none is a placeholder | PASS |  |
| m0a-binding | published authority_version is the value this bundle actually implements | PASS | published=1.7.0 actual=1.7.0 |
...
| m0a-binding | published raw_schema_version is the value this bundle actually implements | PASS | published=1.7 actual=1.7 |
...
| m0a-binding | published schema_registry_sha256 is the value this bundle actually implements | PASS | published=89014a28800ebc2966f34c9e actual=89014a28800ebc2966f34c9e |
...
| m0a-binding | published trusted_shim_source_sha256 is the value this bundle actually implements | PASS | published=327a64620afab3d3fba2f389 actual=327a64620afab3d3fba2f389 |
