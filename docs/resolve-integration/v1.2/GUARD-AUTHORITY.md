# GUARD-AUTHORITY.md — pre-write / re-validation guard (v1.2, FROZEN_NOW)
...
payload_sha256 = sha256( utf8("vidtoolz.resolveSnapshotPayload.v1.2") + 0x0A + canonical(normalized payload) )
```
