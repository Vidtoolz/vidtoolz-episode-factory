...
| C16-M3 append-only evidence store not executable (M0A MAJOR) | evidence-store | 4 | 4 |
| C16-OP1 Hermes M0A binding values not operationally closed | m0a-binding, codex-matrix | 32 | 32 |
...
| R7 F15-07 / M-PRECEDENCE transaction lifecycle precedence | precedence, precedence-supersession, precedence-retired-terms | 130 | 130 |
...
| evidence-attempt-tuple | 14 | 14 |
| evidence-closed-world | 10 | 10 |
| evidence-mode-authority | 12 | 12 |
| evidence-ref-negative | 9 | 9 |
| evidence-ref-positive | 1 | 1 |
| evidence-root-trust | 14 | 14 |
| evidence-semantic-inventory | 13 | 13 |
| evidence-session-identity | 12 | 12 |
| evidence-set-binding | 87 | 87 |
| evidence-set-binding-negative | 9 | 9 |
| evidence-set-schema | 92 | 92 |
| evidence-set-schema-negative | 4 | 4 |
| evidence-single-authority | 3 | 3 |
| evidence-store | 4 | 4 |
| evidence-traversal | 2 | 2 |
| exact-manifest | 8 | 8 |
| f64-exact | 2 | 2 |
...
| precedence | 70 | 70 |
| precedence-retired-terms | 11 | 11 |
| precedence-supersession | 49 | 49 |
...
| evidence-set-schema-negative | attached-evidence-raised-fake-parse-block | PASS | additionalProperties:records/065c53caf107acb3c1ff21a923ee6ff854aa566184bc2bde93c9bbb2d3c9622c/capture:Additional properties are not allowed ('parse', 'result' were unexpected) |
| evidence-set-binding-negative | attached-evidence-raised-fake-parse-block | PASS | 065c53caf107: capture carries forbidden interpretation field 'parse'; 065c53caf107: capture carries forbidden interpretation field 'result' |
| evidence-set-schema | attached-evidence-raw-tampered | PASS |  |
| evidence-set-binding-negative | attached-evidence-raw-tampered | PASS | 00ce41e47293: capture raw_digest does not re-hash; 0d47c26e5b8e: capture raw_digest does not re-hash |
...
| evidence-set-schema-negative | attached-evidence-review-stale-parser | PASS | const:records/01eadac4a8349411cac87b3b1f518662be346f9422cc8121719765a4a22cb6d2/parser_version:'vidtoolz.resolveProbeParser.v1' was expected |
...
| evidence-set-binding-negative | attached-fatal-probe-failure | PASS | 857d76b284c7: capture binding library_root disagrees with envelope/contract/active authority; 857d76b284c7: capture binding library_uuid disagrees with envelope/contract/active authority |
...
| evidence-set-binding-negative | invalid-bundle-other-manifest-not-historical | PASS | 6aec898bb42c: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema | invalid-connection-other-authority | PASS |  |
| evidence-set-binding-negative | invalid-connection-other-authority | PASS | d090c14b9fdf: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.9.0 |
| evidence-set-schema | invalid-connection-wrong-manifest | PASS |  |
| evidence-set-binding-negative | invalid-connection-wrong-manifest | PASS | ab702e5040e7: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema-negative | invalid-provisioning-without-root | PASS | not:records/9f9027f5421c9129f90f7367aced7af87b4a5ea8452e66a837abc481e98875cf/envelope/library_root:None should not be valid under {'type': 'null'} |
| evidence-set-binding-negative | invalid-provisioning-without-root | PASS | 9f9027f5421c: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY |
| evidence-set-schema-negative | invalid-retired-capability-evidence-type | PASS | enum:records/1a3e8e23849ae8f5e000601c782044087ec7784ccd4f9b5990bae73dd44e06f0/record_type:'CAPABILITY_EVIDENCE' is not one of ['BUNDLE_VERIFICATION', 'CONNECTION_OBSERVATION', 'DERIVED_CAPABILITY_RESULT', 'DESTINATION_TI |
| evidence-set-binding-negative | invalid-retired-capability-evidence-type | PASS | 1a3e8e23849a: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review) |
| evidence-set-schema | invalid-tampered-record | PASS |  |
| evidence-set-binding-negative | invalid-tampered-record | PASS | 59b8c4826964: record_id does not match content digest |
...
| evidence-ref-negative | uppercase sha | PASS | M3_AUTHORIZATION: reference is not a sha256 ('6FAF43617CFF2377AE14D44B30CE8415072B1E86FF4F3F2712986B52187033DB') |
| evidence-ref-negative | unlinked sha | PASS | M3_AUTHORIZATION: referenced record 999999999999 not in evidence set |
| evidence-ref-negative | wrong type | PASS | M3_AUTHORIZATION: record 6faf43617cff has type PROVISIONING_RECORD |
| evidence-ref-negative | short hex | PASS | M3_AUTHORIZATION: reference is not a sha256 ('6faf43617cff2377ae14d44b30ce8415072b1e86ff4f3f2712986b52187033d') |
| evidence-ref-negative | sha with newline | PASS | M3_AUTHORIZATION: reference is not a sha256 ('6faf43617cff2377ae14d44b30ce8415072b1e86ff4f3f2712986b52187033db\n') |
...
| attachment-derived | attached-evidence-raised-fake-parse-block -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', "065c53caf107: capture carries forbidden interpretation field 'parse'"] conflicts=[] |
| attachment-derived | attached-evidence-raw-tampered -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '00ce41e47293: capture raw_digest does not re-hash'] conflicts=[] |
...
| attachment-derived | attached-fatal-probe-failure -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '857d76b284c7: capture binding library_root disagrees with envelope/contract/active authority'] conflicts=[] |
...
| attachment-derived | invalid-bundle-other-manifest-not-historical -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '6aec898bb42c: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-connection-other-authority -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'd090c14b9fdf: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.9.0'] conflicts=[] |
| attachment-derived | invalid-connection-wrong-manifest -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'ab702e5040e7: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-provisioning-without-root -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '9f9027f5421c: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY'] conflicts=[] |
| attachment-derived | invalid-retired-capability-evidence-type -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '1a3e8e23849a: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review)'] conflicts=[] |
| attachment-derived | invalid-tampered-record -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '59b8c4826964: record_id does not match content digest'] conflicts=[] |
...
| refreeze-law | a refreeze from another session is refused | PASS | MediaPoolItem.GetMediaId: raw capture from another probe/session |
| refreeze-law | a refreeze from another probe run is refused | PASS | MediaPoolItem.GetMediaId: raw capture from another probe/session |
...
| fixture-schema-negative | plan-authority-version-old | PASS | const:authority_version:'1.9.0' was expected |
| fixture-schema-positive | plan-digest-not-of-body | PASS |  |
| fixture-semantic-negative | plan-digest-not-of-body | PASS | plan_digest does not match plan body digest; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != '000 |
| fixture-schema-positive | plan-duplicate-operation-id | PASS |  |
| fixture-semantic-negative | plan-duplicate-operation-id | PASS | operation ids must be unique and non-empty; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != '0e00 |
| fixture-schema-positive | plan-eligible-without-prepared-journal | PASS |  |
| fixture-eligibility-negative | plan-eligible-without-prepared-journal | PASS | operation APPEND not eligible: ['JOURNAL_PREPARED (JOURNAL_PREPARED: referenced record 8d39b86fd7bb not in evidence set)', 'PLAN_VALIDATED (PLAN_VALIDATION: referenced record 80793b6d74a4 not in evidence set)', 'GUARD_CU |
...
| fixture-semantic-negative | plan-operation-set-digest-mismatch | PASS | operation_set_digest does not match operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != ' |
| fixture-schema-positive | plan-plan-validation-record-fail | PASS |  |
| fixture-eligibility-negative | plan-plan-validation-record-fail | PASS | operation APPEND not eligible: ['PLAN_VALIDATED (PLAN_VALIDATION: referenced record 80793b6d74a4 not in evidence set)'] |
| fixture-schema-positive | plan-read-class-with-append | PASS |  |
| fixture-semantic-negative | plan-read-class-with-append | PASS | RESOLVE_READ permission class cannot carry write operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad617 |
| fixture-schema-positive | plan-selector-target-mismatch | PASS |  |
| fixture-semantic-negative | plan-selector-target-mismatch | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != 'c8d93c608863fae6b51a4adeca9cedac68f3aa66b743acf1 |
| fixture-schema-positive | plan-session-not-current | PASS |  |
| fixture-semantic-negative | plan-session-not-current | PASS | plan session_id != evidence set current_session_id (execution session mismatch); operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae31 |
| fixture-schema-positive | plan-stale-guard | PASS |  |
| fixture-semantic-negative | plan-stale-guard | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != '8f7a2f0ea27da30d9ca0a78a1a62353acdd64ffd69dff671 |
...
| linked-set-negative | linked-set-effect-not-specified-claims-verified | PASS | plan: operation SET_PROPERTIES not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != '8628a550595d68fbe3ac9ad58c85ce36e8 |
...
| eligibility | m0-deny-ref-wrong-record-type | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['READ_ONLY_JOURNAL_OPEN (READ_ONLY_JOURNAL: record 59b8c4826964 has type CONNECTION_OBSERVATION)'] codes=['PREREQUISITES_FAILED'] |
...
| eligibility | m3-append-deny-authorization-old-authority | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record a8b0012ef911 not in evidence set)', 'TARGET_STATE_SCRATCH_WRITE_READY (no M3_AUTHORIZATION  |
...
| eligibility | m3-save-deny-ids-unavailable | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT failed=['M2_EXIT_EVIDENCE (MILESTONE_EXIT: referenced record fe029731d523 not in evidence set)', 'MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record a8b0012ef91 |
...
| eligibility | m3-append-deny-h0-minimal-m0 | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != '8ddf359e17f |
| eligibility-request-schema | m3-append-deny-h0-full-timeline-read | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-full-timeline-read | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != '5666f06ddf0 |
| eligibility-request-schema | m3-append-deny-h0-incomplete-write-precheck | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-incomplete-write-precheck | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != '43a660e6d2c |
| eligibility-request-schema | m3-append-deny-h0-candidate-provenance | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-candidate-provenance | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != '84bc9791d2d |
| eligibility-request-schema | m3-append-deny-h0-other-matrix | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-matrix | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != 'b58d72ec270 |
| eligibility-request-schema | m3-append-deny-h0-other-target | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-target | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record 8d39b86fd7bb plan_digest='752035b468ae46abdfbb4061c2a184a2eae312efda36855f5184ad61705e3924' != 'cf1f4e44d04 |
...
| eligibility | m3-append-deny-plan-validation-from-helper | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["PLAN_VALIDATED (PLAN_VALIDATION: record c46ae9381a04 validator='tools/authority_lib.py#semantic_mutation_plan' != 'tools/authority_lib.py#validate_tra |
...
| precedence | the v1.5 through v1.8 changelogs and finding matrices are HISTORICAL; the v1.9 ones are active | PASS |  |
...
| precedence | the v1.9 evidence-store supersessions S48-S49 are recorded and the v1.9 changelog and matrix are active | PASS |  |
...
| manifest | parent (v1.8) manifest sha pinned | PASS |  |
| manifest | grandparent (v1.7) manifest sha pinned | PASS |  |
| manifest | the parent block records the v1.8 branch HEAD and its semantic commit, which for v1.8 are the same commit because its bundle and registration were committed together (section 31) | PASS |  |
| manifest | v1.0-v1.8 bundles are byte-identical to their frozen manifests (history preserved) | PASS |  |
...
| stored-chain | attached-evidence-duplicate-current-review: refused, and the refusal names the substituted link | PASS | REVIEW: 2 current candidates (5a4285ec67c7, 8a4159ec7776); an explicit supersession is required and insertion order never decides; REVIEW_CONFLICT: no single cu |
...
| stored-chain | attached-evidence-duplicate-current-refreeze: refused, and the refusal names the substituted link | PASS | REFREEZE: 2 current candidates (2c8b135667b9, f38fc2b1a28c); an explicit supersession is required and insertion order never decides; REFREEZE_CONFLICT: no singl |
...
| raw-ingestion | replayed fixture invalid-number-syntax: STRUCTURE_INVALID | PASS | got STRUCTURE_INVALID: STRUCTURE_INVALID: Expecting ',' delimiter: line 1 column 1045 (char 1044) |
| raw-ingestion | replayed fixture non-finite-number: NON_FINITE_NUMBER | PASS | got NON_FINITE_NUMBER: NON_FINITE_NUMBER: NaN |
| raw-ingestion | replayed fixture control-character: CONTROL_CHARACTER | PASS | got CONTROL_CHARACTER: CONTROL_CHARACTER: U+0001 at offset 586 |
...
| evidence-root-trust | the trust boundary is established by lstat BEFORE any resolution: a symlinked evidence root is refused at create_session (v1.8 resolved it away and accepted it) | PASS |  |
| evidence-root-trust | the same session opens fine through the REAL root and verifies clean | PASS |  |
| evidence-root-trust | open_session through the symlinked root is refused ROOT_SYMLINK_REFUSED | PASS |  |
| evidence-root-trust | list_sessions through the symlinked root is refused ROOT_SYMLINK_REFUSED | PASS |  |
| evidence-root-trust | create_session through the symlinked root is refused ROOT_SYMLINK_REFUSED | PASS |  |
| evidence-root-trust | no session may be finalized or verified through the symlink path: the boundary refuses before a store object exists | PASS |  |
| evidence-root-trust | a symlinked SESSION directory entry is refused SESSION_SYMLINK_REFUSED | PASS |  |
| evidence-root-trust | the boundary keeps the literal path and records device+inode, and re-checks them on every operation | PASS |  |
| evidence-root-trust | replacing an established root with a symlink between operations is detected (section 23; detection, not a TOCTOU guarantee) | PASS |  |
| evidence-root-trust | replacing an established root with a DIFFERENT directory is detected as ROOT_REPLACED | PASS |  |
| evidence-root-trust | the root-replacement check is honestly scoped: it compares device and inode, so a replacement that reuses the freed inode is NOT claimed to be detected | PASS |  |
| evidence-root-trust | a root that is a regular file, or absent, is refused ROOT_NOT_A_DIRECTORY | PASS |  |
| evidence-root-trust | the store never resolves a caller root before inspecting it: no os.path.realpath on the trust path, and reads use O_NOFOLLOW | PASS |  |
| evidence-root-trust | the platform scope of the mode and file-type claims is stated as POSIX and not overclaimed (section 25) | PASS |  |
| evidence-session-identity | control: a session in its own directory verifies clean and reports FINALIZED | PASS |  |
| evidence-session-identity | the frozen session identity tuple binds session, probe, authority, store, host/build, library, shim, spec, registry and directory basename (section 5) | PASS |  |
| evidence-session-identity | the session path law is policy A: the directory basename IS the session id, and the manifest says so | PASS |  |
| evidence-session-identity | RENAMED SESSION (Codex S19-2): a finalized session moved to another directory name is refused SESSION_PATH_MISMATCH / SESSION_IDENTITY_MISMATCH. v1.8 verified it clean. | PASS | INTERNAL_IDENTITY_MISMATCH: RAW/c9/c9eb65e5992ecca02b7365ed7996f86c745890162483a26024a87c5d29b89e97.json names session 'sess-identity' inside a record of session 'sess-re |
| evidence-session-identity | renaming it back restores a clean verification | PASS |  |
| evidence-session-identity | cross-session attack: the whole finalized session copied to another directory name is refused | PASS | INTERNAL_IDENTITY_MISMATCH: RAW/c9/c9eb65e5992ecca02b7365ed7996f86c745890162483a26024a87c5d29b89e97.json names session 'sess-identity' inside a record |
| evidence-session-identity | cross-session attack: the inventory alone copied from another session is refused | PASS | EVIDENCE_REPLACED: JOURNAL.ndjson byte count 1179 != inventory 1159 |
| evidence-session-identity | cross-session attack: the finalization marker alone copied from another session is refused | PASS | FINALIZATION_MARKER_INVALID: marker does not name this inventory |
| evidence-session-identity | cross-session attack: the session manifest alone copied from another session is refused | PASS | EVIDENCE_REPLACED: SESSION.json byte count 2077 != inventory 2092 |
| evidence-session-identity | cross-session attack: one record copied from another session is refused | PASS | UNEXPECTED_ENTRY: AUTHORITY_PROMOTION/6f/6fa510124ea6d7ed74577af1fb81f74eec4948d5694b3726572c5580bab32e1b.json is present on disk but not in the final |
| evidence-session-identity | after every cross-session attack is reverted both sessions verify clean again | PASS |  |
| evidence-session-identity | the finalization marker binds session identity, inventory digest, store and authority version and the expected final state (section 20) | PASS |  |
| evidence-semantic-inventory | the inventory records layer, record key, logical identity, attempt ids and keys, record-internal session and probe ids, file type and mode for every governed entry (sections 7/8/16) | PASS |  |
| evidence-semantic-inventory | verification reports four counters and PASS requires all four to be zero (section 15) | PASS |  |
| evidence-semantic-inventory | a record's storage name recomputes from its semantics: sha256 over session, layer, logical identity and content digest (section 8) | PASS |  |
| evidence-semantic-inventory | a RAW capture record's internal session id is extracted and reconciled against the session it lives in (section 7) | PASS | internal=sess-semantic session=sess-semantic |
| evidence-semantic-inventory | LAYER COLLISION (section 9): an inventory that records a different layer than the path holds is LAYER_IDENTITY_MISMATCH | PASS | FINALIZATION_MARKER_INVALID: marker does not name this inventory |
| evidence-semantic-inventory | LOGICAL IDENTITY COLLISION (section 10): rebinding a stored record to another logical identity is LOGICAL_IDENTITY_MISMATCH | PASS | FINALIZATION_MARKER_INVALID: marker does not name this inventory |
| evidence-semantic-inventory | a record key that does not recompute from the record's semantics is refused | PASS | FINALIZATION_MARKER_INVALID: marker does not name this inventory |
| evidence-semantic-inventory | a changed record-internal session id is INTERNAL_IDENTITY_MISMATCH | PASS | FINALIZATION_MARKER_INVALID: marker does not name this inventory |
| evidence-semantic-inventory | a duplicate path in the inventory is INVENTORY_DUPLICATE_KEY, refused before any index is built (section 21) | PASS | FINALIZATION_MARKER_INVALID: marker does not name this inventory |
| evidence-semantic-inventory | a duplicate record key under a second path is INVENTORY_DUPLICATE_KEY | PASS | FINALIZATION_MARKER_INVALID: marker does not name this inventory |
| evidence-semantic-inventory | an inventory naming another session id is SESSION_PATH_MISMATCH / SESSION_IDENTITY_MISMATCH | PASS | FINALIZATION_MARKER_INVALID: marker does not name this inventory |
| evidence-semantic-inventory | a valid record copied into another LAYER keeps its old key, so the recomputation fails and it is refused | PASS | UNEXPECTED_ENTRY: DERIVED/3c/3c544736c72f969a5a270601386c094bf7629062d335f5456b3fe8f301abcbf8.json is present on disk but not in the finalized invento |
| evidence-semantic-inventory | the session verifies clean after every semantic attack is reverted | PASS |  |
| evidence-attempt-tuple | the canonical attempt key is the tuple (session, layer, logical identity, attempt id), not a digest (section 11) | PASS |  |
| evidence-attempt-tuple | same tuple, same bytes: idempotent, same record, no second copy | PASS |  |
| evidence-attempt-tuple | same tuple, different bytes: refused ATTEMPT_ID_REUSED | PASS |  |
| evidence-attempt-tuple | same attempt id, different LAYER (v1.8 accepted this and made a second record): refused ATTEMPT_ID_CROSS_LAYER | PASS |  |
| evidence-attempt-tuple | same attempt id, different LOGICAL IDENTITY: refused ATTEMPT_ID_CROSS_IDENTITY | PASS |  |
| evidence-attempt-tuple | RAW attempt reused in DERIVED: refused ATTEMPT_ID_CROSS_LAYER | PASS |  |
| evidence-attempt-tuple | a write with no logical identity at all: refused LOGICAL_IDENTITY_INVALID | PASS |  |
| evidence-attempt-tuple | a DIFFERENT attempt id may legitimately carry the same bytes into another layer, and gets its own semantic key | PASS |  |
| evidence-attempt-tuple | DERIVED attempt reused in HUMAN_REVIEW is refused ATTEMPT_ID_CROSS_LAYER | PASS |  |
| evidence-attempt-tuple | the same digest under two logical identities is two DISTINCT records with distinct semantic keys (documented deterministic outcome, section 14) | PASS |  |
| evidence-attempt-tuple | the same attempt id in a DIFFERENT session is allowed and produces a different attempt key and a different record key (the tuple includes the session) | PASS |  |
| evidence-attempt-tuple | both attempt sessions finalize and verify clean | PASS |  |
| evidence-attempt-tuple | an attempt marker copied from another session is refused (its tuple names the wrong session) | PASS | EVIDENCE_REPLACED: ATTEMPTS/att-1 byte count 259 != inventory 263 |
| evidence-attempt-tuple | attempt indexes are built from a list and duplicate tuple keys refuse before any map exists (section 13) | PASS |  |
| evidence-mode-authority | canonical modes are set explicitly rather than left to the umask, and are recorded in the inventory (section 17) | PASS |  |
| evidence-mode-authority | CHMOD a stored record after finalization is detected as MODE_MISMATCH (v1.8 did not notice) | PASS | MODE_MISMATCH: AUTHORITY_PROMOTION/d0/d0fc4b8442322b9bc7edcd5647f03faf8ec29c1e97727bb758d2fb2453a8ef51.json mode 0o666, inventory records 0o400 |
| evidence-mode-authority | CHMOD a layer directory after finalization is detected as MODE_MISMATCH (v1.8 did not notice) | PASS | MODE_MISMATCH: directory RAW mode 0o777, inventory records 0o700 |
| evidence-mode-authority | CHMOD the session manifest after finalization is detected as MODE_MISMATCH (v1.8 did not notice) | PASS | MODE_MISMATCH: SESSION.json mode 0o666, inventory records 0o444 |
| evidence-mode-authority | CHMOD the attempts directory after finalization is detected as MODE_MISMATCH (v1.8 did not notice) | PASS | MODE_MISMATCH: directory ATTEMPTS mode 0o750, inventory records 0o700 |
| evidence-mode-authority | CHMOD an attempt marker after finalization is detected as MODE_MISMATCH (v1.8 did not notice) | PASS | MODE_MISMATCH: ATTEMPTS/sess-mode:1003 mode 0o644, inventory records 0o400 |
| evidence-mode-authority | CHMOD the INVENTORY after finalization is detected | PASS | MODE_MISMATCH: INVENTORY.json mode 0o666, canonical mode is 0o444 |
| evidence-mode-authority | CHMOD the FINALIZED marker after finalization is detected | PASS | MODE_MISMATCH: FINALIZED mode 0o666, canonical mode is 0o444 |
| evidence-mode-authority | the session verifies clean once every mode is restored | PASS |  |
| evidence-mode-authority | only POSIX file type and permission bits are frozen: no inode, timestamp or owner is recorded (section 16) | PASS |  |
| evidence-mode-authority | a regular file replaced by another filesystem type at the same path is refused even though the path exists (section 19) | PASS | FILE_TYPE_REJECTED: MODE_0o10000 at AUTHORITY_PROMOTION/d0/d0fc4b8442322b9bc7edcd5647f03faf8ec29c1e97727bb758d2fb2453a8ef51.json |
| evidence-mode-authority | restoring the regular file with its canonical mode verifies clean again | PASS |  |
| evidence-closed-world | control: the untouched finalized session verifies clean | PASS |  |
| evidence-closed-world | STORE-14 (Codex, pinned regression) still closed: an unexpected file in the finalized session ROOT is UNEXPECTED_ENTRY and the session is INVALID | PASS | UNEXPECTED_ENTRY: PLANTED-BY-ATTACKER.json is present on disk but not in the finalized inventory |
| evidence-closed-world | still closed: an unexpected nested file inside a layer invalidates the session | PASS | UNEXPECTED_ENTRY: RAW/EXTRA-NESTED.json is present on disk but not in the finalized inventory |
| evidence-closed-world | still closed: an unexpected directory invalidates the session | PASS | UNEXPECTED_ENTRY: directory EXTRA-DIR is present on disk but not in the finalized inventory |
| evidence-closed-world | still closed: an unexpected nested directory invalidates the session | PASS | UNEXPECTED_ENTRY: directory DERIVED/EXTRA-DIR is present on disk but not in the finalized inventory |
| evidence-closed-world | still closed: an unexpected file in the attempts index invalidates the session | PASS | UNEXPECTED_ENTRY: ATTEMPTS/forged is present on disk but not in the finalized inventory |
| evidence-closed-world | post-finalization writes through the API are still refused (all four layers and re-finalization) | PASS |  |
...
| evidence-closed-world | the session verifies clean after every retained-regression attack | PASS |  |
| evidence-traversal | every one of 20 identifier shapes is still refused by all eight entry points, on attempt ids AND logical identities | PASS | accepted:  |
| evidence-traversal | no file appeared outside the session root during the traversal battery (legacy EvidenceRoot regression still closed) | PASS |  |
| evidence-single-authority | exactly one module is still EVIDENCE_STORE_AUTHORIZING and the capture shim has no storage surface | PASS |  |
| evidence-single-authority | the write API still exposes no path parameter | PASS |  |
| evidence-single-authority | content addressing is retained: every verification recomputes the bytes | PASS |  |
| evidence-store | partial state is retained: an unfinalized session is ACTIVE, a stray temp file makes it PARTIAL and blocks finalization | PASS |  |
...
| evidence-store | a caller-declared digest is still compared and never trusted, and the same tuple with different bytes is still refused | PASS |  |
...
| codex-matrix | the ACTIVE v1.9 finding-resolution matrix enumerates exactly the four Codex v1.8 evidence-store ids | PASS |  |
| codex-matrix | S19-1: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 14 checks; failing=[] |
| codex-matrix | S19-2: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 25 checks; failing=[] |
| codex-matrix | S19-3: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 14 checks; failing=[] |
| codex-matrix | S19-4: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 12 checks; failing=[] |
| m0a-binding | every Hermes M0A binding value is published and none is a placeholder | PASS |  |
| m0a-binding | published authority_version is the value this bundle actually implements | PASS | published=1.9.0 actual=1.9.0 |
...
| m0a-binding | published evidence_store_sha256 is the value this bundle actually implements | PASS | published=c924def2d846f2491a5c8366 actual=c924def2d846f2491a5c8366 |
...
| m0a-binding | published raw_schema_version is the value this bundle actually implements | PASS | published=1.9 actual=1.9 |
...
| m0a-binding | published schema_registry_sha256 is the value this bundle actually implements | PASS | published=5cc2b177b5b6f82f87069c22 actual=5cc2b177b5b6f82f87069c22 |
