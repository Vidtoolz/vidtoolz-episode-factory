...
| R7 F15-07 / M-PRECEDENCE transaction lifecycle precedence | precedence, precedence-supersession, precedence-retired-terms | 182 | 182 |
...
| precedence | 105 | 105 |
| precedence-retired-terms | 15 | 15 |
| precedence-supersession | 62 | 62 |
...
| evidence-set-binding-negative | attached-evidence-raised-fake-parse-block | PASS | 0b8527457cf0: capture carries forbidden interpretation field 'parse'; 0b8527457cf0: capture carries forbidden interpretation field 'result' |
| evidence-set-schema | attached-evidence-raw-tampered | PASS |  |
| evidence-set-binding-negative | attached-evidence-raw-tampered | PASS | 14480a06ed2c: capture raw_digest does not re-hash; 154ed2f38517: capture raw_digest does not re-hash |
...
| evidence-set-binding-negative | attached-fatal-probe-failure | PASS | 46bd11d6e937: capture binding library_root disagrees with envelope/contract/active authority; 46bd11d6e937: capture binding library_uuid disagrees with envelope/contract/active authority |
...
| evidence-set-binding-negative | invalid-bundle-other-manifest-not-historical | PASS | b841071533c5: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest |
| evidence-set-schema | invalid-connection-other-authority | PASS |  |
| evidence-set-binding-negative | invalid-connection-other-authority | PASS | f9e692f8f87e: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.15.0 |
| evidence-set-schema | invalid-connection-wrong-manifest | PASS |  |
| evidence-set-binding-negative | invalid-connection-wrong-manifest | PASS | 79bdda58e88a: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest |
...
| evidence-set-binding-negative | invalid-provisioning-without-root | PASS | 0d53ac58e3ab: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY |
...
| evidence-set-binding-negative | invalid-retired-capability-evidence-type | PASS | 1fa7ce055b12: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review) |
| evidence-set-schema | invalid-tampered-record | PASS |  |
| evidence-set-binding-negative | invalid-tampered-record | PASS | 0f5ba9901c67: record_id does not match content digest |
...
| evidence-ref-negative | uppercase sha | PASS | M3_AUTHORIZATION: reference is not a sha256 ('62F8B383D496AE623C15CD35EA2C342412ED2446E62D6799F5DEE6CEF44C851B') |
| evidence-ref-negative | unlinked sha | PASS | M3_AUTHORIZATION: referenced record 999999999999 not in evidence set |
| evidence-ref-negative | wrong type | PASS | M3_AUTHORIZATION: record 62f8b383d496 has type PROVISIONING_RECORD |
| evidence-ref-negative | short hex | PASS | M3_AUTHORIZATION: reference is not a sha256 ('62f8b383d496ae623c15cd35ea2c342412ed2446e62d6799f5dee6cef44c851') |
...
| attachment-derived | attached-evidence-raised-fake-parse-block -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', "0b8527457cf0: capture carries forbidden interpretation field 'parse'"] conflicts=[] |
| attachment-derived | attached-evidence-raw-tampered -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '14480a06ed2c: capture raw_digest does not re-hash'] conflicts=[] |
...
| attachment-derived | attached-fatal-probe-failure -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '46bd11d6e937: capture binding library_root disagrees with envelope/contract/active authority'] conflicts=[] |
...
| attachment-derived | invalid-bundle-other-manifest-not-historical -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'b841071533c5: BUNDLE_VERIFICATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-connection-other-authority -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', 'f9e692f8f87e: CONNECTION_OBSERVATION bound to authority 1.5.0 != active 1.15.0'] conflicts=[] |
| attachment-derived | invalid-connection-wrong-manifest -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '79bdda58e88a: CONNECTION_OBSERVATION bound to manifest 999999999999 != active reviewed manifest'] conflicts=[] |
| attachment-derived | invalid-provisioning-without-root -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '0d53ac58e3ab: PROVISIONING_RECORD: envelope.library_root required at level LIBRARY'] conflicts=[] |
| attachment-derived | invalid-retired-capability-evidence-type -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '1fa7ce055b12: record_type CAPABILITY_EVIDENCE is RETIRED in v1.6 (capability evidence is RAW_CAPABILITY_CAPTURE + derived result + review)'] conflicts=[] |
| attachment-derived | invalid-tampered-record -> CONFLICT | PASS | got CONFLICT; failures=['EVIDENCE_SET_INVALID', '0f5ba9901c67: record_id does not match content digest'] conflicts=[] |
...
| refreeze-law | a refreeze from another session is refused | PASS | Project.GetName: raw capture from another probe/session |
| refreeze-law | a refreeze from another probe run is refused | PASS | Project.GetName: raw capture from another probe/session |
...
| fixture-schema-negative | plan-authority-version-old | PASS | const:authority_version:'1.15.0' was expected |
| fixture-schema-positive | plan-digest-not-of-body | PASS |  |
| fixture-semantic-negative | plan-digest-not-of-body | PASS | plan_digest does not match plan body digest; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record cdc6d |
| fixture-schema-positive | plan-duplicate-operation-id | PASS |  |
| fixture-semantic-negative | plan-duplicate-operation-id | PASS | operation ids must be unique and non-empty; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record cdc6df |
| fixture-schema-positive | plan-eligible-without-prepared-journal | PASS |  |
| fixture-eligibility-negative | plan-eligible-without-prepared-journal | PASS | operation APPEND not eligible: ['JOURNAL_PREPARED (JOURNAL_PREPARED: referenced record d3f5869bbcc4 not in evidence set)', 'PLAN_VALIDATED (PLAN_VALIDATION: referenced record cdc6df1a2c68 not in evidence set)', 'GUARD_CU |
...
| fixture-semantic-negative | plan-operation-set-digest-mismatch | PASS | operation_set_digest does not match operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record cd |
| fixture-schema-positive | plan-plan-validation-record-fail | PASS |  |
| fixture-eligibility-negative | plan-plan-validation-record-fail | PASS | operation APPEND not eligible: ['PLAN_VALIDATED (PLAN_VALIDATION: referenced record cdc6df1a2c68 not in evidence set)'] |
| fixture-schema-positive | plan-read-class-with-append | PASS |  |
| fixture-semantic-negative | plan-read-class-with-append | PASS | RESOLVE_READ permission class cannot carry write operations; operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATI |
| fixture-schema-positive | plan-selector-target-mismatch | PASS |  |
| fixture-semantic-negative | plan-selector-target-mismatch | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record cdc6df1a2c68 plan_digest='<SHA256>' != '<SHA256>') |
| fixture-schema-positive | plan-session-not-current | PASS |  |
| fixture-semantic-negative | plan-session-not-current | PASS | plan session_id != evidence set current_session_id (execution session mismatch); operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALI |
| fixture-schema-positive | plan-stale-guard | PASS |  |
| fixture-semantic-negative | plan-stale-guard | PASS | operation APPEND not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record cdc6df1a2c68 plan_digest='<SHA256>' != '<SHA256>') |
...
| linked-set-negative | linked-set-effect-not-specified-claims-verified | PASS | plan: operation SET_PROPERTIES not eligible: ["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "PLAN_VALIDATED (PLAN_VALIDATION: record cdc6df1a2c68 plan_digest='<SHA256>'  |
...
| eligibility | m0-deny-ref-wrong-record-type | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['READ_ONLY_JOURNAL_OPEN (READ_ONLY_JOURNAL: record 0f5ba9901c67 has type CONNECTION_OBSERVATION)'] codes=['PREREQUISITES_FAILED'] |
...
| eligibility | m3-append-deny-authorization-old-authority | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT_TIMELINE failed=['MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record 31fcc8c26ecb not in evidence set)', 'TARGET_STATE_SCRATCH_WRITE_READY (no M3_AUTHORIZATION  |
...
| eligibility | m3-save-deny-ids-unavailable | PASS | eligible=False state=ATTACHED_READ_ONLY tr=PROJECT failed=['M2_EXIT_EVIDENCE (MILESTONE_EXIT: referenced record eb14becf9455 not in evidence set)', 'MIKKO_M3_AUTHORIZATION (M3_AUTHORIZATION: referenced record 31fcc8c26ec |
...
| eligibility | m3-append-deny-h0-minimal-m0 | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_PROFILE: snapshot profile 'MINIMAL_ |
| eligibility-request-schema | m3-append-deny-h0-full-timeline-read | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-full-timeline-read | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_PROFILE: snapshot profile 'FULL_TIM |
| eligibility-request-schema | m3-append-deny-h0-incomplete-write-precheck | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-incomplete-write-precheck | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", "GUARD_CURRENT (H0_INCOMPLETE: guarded snapshot is not |
| eligibility-request-schema | m3-append-deny-h0-candidate-provenance | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-candidate-provenance | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_PROVENANCE: Folder.GetUniqueId is C |
| eligibility-request-schema | m3-append-deny-h0-other-matrix | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-matrix | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_MATRIX: guarded snapshot collected  |
| eligibility-request-schema | m3-append-deny-h0-other-target | PASS | request schema-valid=True |
| eligibility | m3-append-deny-h0-other-target | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["JOURNAL_PREPARED (JOURNAL_PREPARED: record d3f5869bbcc4 plan_digest='<SHA256>' != '<SHA256>')", 'GUARD_CURRENT (H0_TARGET: guarded snapshot identity d |
...
| eligibility | m3-append-deny-plan-validation-from-helper | PASS | eligible=False state=SCRATCH_WRITE_READY tr=PROJECT_TIMELINE failed=["PLAN_VALIDATED (PLAN_VALIDATION: record 9901c234243a validator='tools/authority_lib.py#semantic_mutation_plan' != 'tools/authority_lib.py#validate_tra |
...
| precedence-retired-terms | CHANGELOG-v1.15.md | PASS |  |
...
| precedence-retired-terms | FINDING-RESOLUTION-MATRIX-v1.15.md | PASS |  |
...
| precedence | the v1.5 through v1.14 changelogs and finding matrices are HISTORICAL; the v1.15 ones are active | PASS |  |
...
| precedence | the v1.15 consumed-evidence supersession S62 is recorded, the v1.15 changelog and matrix are active, and the document version tracks the authority version | PASS |  |
...
| manifest | parent (v1.14) manifest sha pinned | PASS |  |
| manifest | grandparent (v1.13) manifest sha pinned | PASS |  |
...
| manifest | the parent block records the v1.14 branch HEAD and its semantic commit, which for v1.14 are the same commit because its bundle and registration were committed together (section 44) | PASS |  |
| manifest | v1.0-v1.14 bundles are byte-identical to their frozen manifests (history preserved) | PASS |  |
...
| b3-active-naming | the audit actually scanned every CURRENT artifact, machine and prose, not a sample (53 documents) | PASS | 53 scanned |
...
| stored-chain | attached-evidence-duplicate-current-review: refused, and the refusal names the substituted link | PASS | REVIEW: 2 current candidates (8ed05506d2ba, a08baf03b623); an explicit supersession is required and insertion order never decides; REVIEW_CONFLICT: no single cu |
...
| stored-chain | attached-evidence-duplicate-current-refreeze: refused, and the refusal names the substituted link | PASS | REFREEZE: 2 current candidates (6fa8b64f916b, d58aff0f9f2c); an explicit supersession is required and insertion order never decides; REFREEZE_CONFLICT: no singl |
...
| evidence-boundary-fields | F110-A pinned: receipt field authority_version (FROZEN_CONSTANT) rewritten with a recomputed boundary_sha256 refuses the next canonical operation. v1.10 accepted schema, evidence_store_version, authority_version and platform_scope. | PASS | BOUNDARY_RECEIPT_INVALID: authority_version='1.10.0' is not the frozen FROZEN_CONSTANT '1.15.0' of this ev |
...
| codex-matrix | Store.v5 carries NO semantic change in v1.15: evidence_store.py differs from the v1.14 bundle by exactly one comment line and every semantic constant is identical | PASS | one comment line |
...
| codex-matrix | the ACTIVE v1.15 finding-resolution matrix enumerates exactly Codex's six v1.14 release findings | PASS |  |
| codex-matrix | the v1.15 matrix records the four-BLOCKER/one-MAJOR/one-MINOR adjudication, the frozen v1.14 reproduction head, the essential law and the honest residual | PASS |  |
| codex-matrix | every v1.15 finding pins its reproduction against the frozen v1.14 head and names a severity Codex assigned | PASS |  |
| codex-matrix | the two findings whose reproduction proved WIDER than reported say so (V114-B4's FIFO hang and raw IsADirectoryError; V114-N1's five-domain gap) | PASS |  |
...
| codex-matrix | the markdown matrix mirrors the machine form: all six ids, every validation section they name, and the stated residual | PASS |  |
...
| codex-matrix | V114-B1: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 29 checks; failing=[] |
| codex-matrix | V114-B2: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 23 checks; failing=[] |
| codex-matrix | V114-B3: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 14 checks; failing=[] |
| codex-matrix | V114-B4: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 21 checks; failing=[] |
| codex-matrix | V114-M1: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 25 checks; failing=[] |
| codex-matrix | V114-N1: correction, negative fixture and expected layer are named, and its validation sections all pass | PASS | 14 checks; failing=[] |
| m0a-binding | every Hermes M0A binding value is published and none is a placeholder | PASS |  |
| m0a-binding | published authority_version is the value this bundle actually implements | PASS | published=1.15.0 actual=1.15.0 |
...
| m0a-binding | published evidence_store_sha256 is the value this bundle actually implements | PASS | published=4544e81bf3a87dfc9bde63bb actual=4544e81bf3a87dfc9bde63bb |
...
| m0a-binding | published schema_registry_sha256 is the value this bundle actually implements | PASS | published=c55cc09e6f0b2659bfc05350 actual=c55cc09e6f0b2659bfc05350 |
