...
rec("precedence", "the v1.5 through v1.16 changelogs and finding matrices are HISTORICAL; the v1.19 ones are active", all(st_.get(d_) == "HISTORICAL" for d_ in ("CHANGELOG-v1.5.md", "FINDING-RESOLUTION-MATRIX-v1.5.md", "CHANGELOG-v1.6.md", "FINDING-RESOLUTION-MATRIX-v1.6.md", "CHANGELOG-v1.7.md", "FINDING-RESOLUTION-MATRIX-v1.7.md", "CHANGELOG-v1.8.md", "FINDING-RESOLUTION-MATRIX-v1.8.md", "CHANGELOG-v1.9.md", "FINDING-RESOLUTION-MATRIX-v1.9.md", "CHANGELOG-v1.10.md", "FINDING-RESOLUTION-MATRIX-v1.10.md", "CHANGELOG-v1.11.md", "FINDING-RESOLUTION-MATRIX-v1.11.md", "CHANGELOG-v1.12.md", "FINDING-RESOLUTION-MATRIX-v1.12.md", "CHANGELOG-v1.13.md", "FINDING-RESOLUTION-MATRIX-v1.13.md", "CHANGELOG-v1.14.md", "FINDING-RESOLUTION-MATRIX-v1.14.md", "CHANGELOG-v1.15.md", "FINDING-RESOLUTION-MATRIX-v1.15.md", "CHANGELOG-v1.16.md", "FINDING-RESOLUTION-MATRIX-v1.16.md")) and st_.get("CHANGELOG-v1.19.md") == "STILL_ACTIVE" and st_.get("FINDING-RESOLUTION-MATRIX-v1.19.md") == "STILL_ACTIVE")
...
if os.path.exists(man_path):
    ...
    parent = L.strict_load(os.path.join(os.path.dirname(B), "v1.18", "FREEZE-MANIFEST.json"))
    ...
    rec("manifest", "the parent block records the v1.18 branch HEAD and its semantic commit, which for v1.18 are the same commit because its bundle and registration were committed together (section 29)", man["parent"]["head"] == "5d9dbba7c9f136caf694debe177f61168e5c4271" and man["parent"]["semantic_head"] == "5d9dbba7c9f136caf694debe177f61168e5c4271" and man["parent"]["manifest_sha256"] == "80b108e4e142841af38827d3b6170c1260c543740f21b03ebb3d934278723ae9" and man["parent"]["version"] == "1.18.0" and {a["version"] for a in man["parent"]["ancestors"]} >= {"1.15.0", "1.14.0", "1.13.0"})
...
import v119_tests
v119_tests.run(B, rec)
import v119_defect_tests
v119_defect_tests.run(B, rec)
