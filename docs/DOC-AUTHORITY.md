...
- `docs/resolve-integration/v1.2/` — Resolve execution subsystem authority bundle, current version (v1.2 correction of v1.1; `docs/resolve-integration/v1.1/` and `docs/resolve-integration/v1/` are immutable history; `experiments/quarantine-2026-09-08/` holds the quarantined non-authoritative prototypes).
