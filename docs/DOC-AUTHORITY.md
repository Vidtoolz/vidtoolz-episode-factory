...
| Resolve execution subsystem | `docs/resolve-integration/v1.20/FREEZE-MANIFEST.json` (current authority) | Candidate for independent review only. Evidence store and authoring implementations are in `docs/resolve-integration/v1.20/tools/`. No run or human authorization is implied. |
...
| --- | --- | --- | --- |
| 1.20.0 | `docs/resolve-integration/v1.20/` | read `docs/resolve-integration/v1.20/FREEZE-MANIFEST.json` | **CURRENT** — implementation-author candidate; independent review required |
| 1.19.0 | `docs/resolve-integration/v1.19/` | `06811f07b422d1cdf30ae6c076bae2bc0b598fc3ac464a0e180a8553a76a2848` | HISTORICAL — ACCEPTED (independent review 2026-09-20, Mikko acceptance recorded in `docs/resolve-integration/adjudications/2026-09-20-v1.19-acceptance/`); SUPERSEDED by 1.20.0 |
...
<!-- resolve-current-selector {"version":"1.20.0","status":"CURRENT","branch":"docs/resolve-authority-freeze-v1.20","parent":"5efbcae6a36b76d4a359f3e65e503336576575c7","manifest":"docs/resolve-integration/v1.20/FREEZE-MANIFEST.json"} -->

**v1.20 registration** (current):

```
branch    docs/resolve-authority-freeze-v1.20
parent    5efbcae6a36b76d4a359f3e65e503336576575c7
manifest  read docs/resolve-integration/v1.20/FREEZE-MANIFEST.json
```

**v1.19 registration** (historical, ACCEPTED; SUPERSEDED):

```
branch    docs/resolve-authority-freeze-v1.19
head      5efbcae6a36b76d4a359f3e65e503336576575c7
parent    5d9dbba7c9f136caf694debe177f61168e5c4271
manifest  06811f07b422d1cdf30ae6c076bae2bc0b598fc3ac464a0e180a8553a76a2848
```
...
The **current** bundle's manifest digest is deliberately **not** restated here — today that is v1.20.
...
in the same commit as the v1.20 bundle, so the pin is fresh rather than a follow-up, and the four intake identities
including the commit HEAD are published in the v1.20 authoring report and handoff.
