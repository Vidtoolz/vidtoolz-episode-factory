...
require("./earth-studio-position-trajectory.test.js");
require("./earth-studio-position-trajectory-review.test.js");
require("./earth-studio-travel-altitude-calibration.test.js");
require("./earth-studio-height-framing.test.js");
require("./earth-studio-position-trajectory-production-framing.test.js");
require("./earth-studio-position-trajectory-calm-motion.test.js");
