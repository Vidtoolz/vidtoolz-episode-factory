...
test('extended ownership canary: changed Visual Plan resumes only through an immutable successor', async () => {
  ...
  const dependencies = ['visual-planning-director.js', 'draft-bespoke-still-policy.js', 'agent-executable-boundary.js', 'agent-dispatch-authority.js', 'execution-ownership.js', 'execution-ownership-authority-anchor.js', 'operator-action-ledger.js', 'successor-task-contract.js', 'visual-planning-successor.js', 'visual-planning-manual-edit.js', 'story-successor.js', 'story-assertion-continuity.js', 'story-revision-review.js', 'agent-task-visual-planning.js', 'package-run-production-mode.js', 'script-builder-authority.js', 'human-approval-identity.js', 'agent-run.js', 'agent-controls.js', 'operational-rationale.js', 'visual-plan.js', 'visual-plan-prompt-adapter.js', 'research-result-validator.js', 'research-result-authority.js', 'agent-contract-validator.js', 'approval-scopes.js'];
  fs.mkdirSync(path.join(root, 'scripts'), { recursive: true });
